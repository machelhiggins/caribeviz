...
public abstract class AbstractMapPane extends JPanel 
    ...
    /**
     * Default background color (opaque).
     */
    public static final Color DEFAULT_BACKGROUND_COLOR = new Color(255,255,255,Color.OPAQUE);
     ...
     */
    //@Override
    public void reset(ReferencedEnvelope fe) {
        paramsLock.writeLock().lock();
        try {
            if (fullExtent != null) {
