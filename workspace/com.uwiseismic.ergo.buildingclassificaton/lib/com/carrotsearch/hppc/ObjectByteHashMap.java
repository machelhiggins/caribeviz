...
/**
 * A hash map of <code>Object</code> to <code>byte</code>, implemented using open
             ...
             Cloneable
{
   ...
   *          consequences.
   */
  public ObjectByteHashMap(int expectedElements, double loadFactor, HashOrderMixingStrategy orderMixer) {
  ...
  public final class KeysContainer extends AbstractObjectCollection<KType> 
    ...
    private final ObjectByteHashMap<KType> owner = ObjectByteHashMap.this;
    ...
    public <T extends ObjectProcedure<? super KType>> T forEach(final T procedure) {
      owner.forEach(new ObjectByteProcedure<KType>() {
        @Override
    ...
    public <T extends ObjectPredicate<? super KType>> T forEach(final T predicate) {
      owner.forEach(new ObjectBytePredicate<KType>() {
        @Override
  ...
  private final class ValuesContainer extends AbstractByteCollection {
    ...
    public int removeAll(final byte e) {
      return owner.removeAll(new ObjectBytePredicate<KType>() {
        @Override
        public boolean apply(KType key, byte value) {
          return ((value) == (e));
        }
  ...
  public ObjectByteHashMap<KType> clone() {
    try {
      /*  */
      ObjectByteHashMap<KType> cloned = (ObjectByteHashMap<KType>) super.clone();
  ...
  public static <KType> ObjectByteHashMap<KType> from(KType[] keys, byte[] values) {
    ...
    ObjectByteHashMap<KType> map = new ObjectByteHashMap<>(keys.length);
