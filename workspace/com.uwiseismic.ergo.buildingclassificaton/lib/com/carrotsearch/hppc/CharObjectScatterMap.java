...
/**
 * Same as {@link CharObjectHashMap} but does not implement per-instance
...
public class CharObjectScatterMap<VType> extends CharObjectHashMap<VType>
{
  /**
  ...
  public static <VType> CharObjectScatterMap<VType> from(char[] keys, VType[] values) {
    ...
    CharObjectScatterMap<VType> map = new CharObjectScatterMap<>(keys.length);
