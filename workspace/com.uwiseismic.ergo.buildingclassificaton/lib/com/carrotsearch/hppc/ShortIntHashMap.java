             ...
             Cloneable
{
  ...
  public final class KeysContainer extends AbstractShortCollection 
    ...
    private final ShortIntHashMap owner = ShortIntHashMap.this;
    ...
    public <T extends ShortProcedure> T forEach(final T procedure) {
      owner.forEach(new ShortIntProcedure() {
        @Override
    ...
    public <T extends ShortPredicate> T forEach(final T predicate) {
      owner.forEach(new ShortIntPredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractIntCollection {
    ...
    public int removeAll(final int e) {
      return owner.removeAll(new ShortIntPredicate() {
        @Override
        public boolean apply(short key, int value) {
          return ((value) == (e));
        }
