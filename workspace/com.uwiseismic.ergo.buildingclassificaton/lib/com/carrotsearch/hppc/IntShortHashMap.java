             ...
             Cloneable
{
   ...
   */
  public IntShortHashMap(IntShortAssociativeContainer container) {
    this(container.size());
    putAll(container);
  }
  ...
  public final class KeysContainer extends AbstractIntCollection 
    ...
    private final IntShortHashMap owner = IntShortHashMap.this;
    ...
    public <T extends IntProcedure> T forEach(final T procedure) {
      owner.forEach(new IntShortProcedure() {
        @Override
    ...
    public <T extends IntPredicate> T forEach(final T predicate) {
      owner.forEach(new IntShortPredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractShortCollection {
    ...
    public int removeAll(final short e) {
      return owner.removeAll(new IntShortPredicate() {
        @Override
        public boolean apply(int key, short value) {
          return ((value) == (e));
        }
   ...
   */
  public static  IntShortHashMap from(int[] keys, short[] values) {
    if (keys.length != values.length) {
      throw new IllegalArgumentException("Arrays of keys and values must have an identical length.");
    }

    IntShortHashMap map = new IntShortHashMap(keys.length);
