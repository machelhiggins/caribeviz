             ...
             Cloneable
{
   ...
   */
  public LongDoubleHashMap(int expectedElements, double loadFactor) {
   ...
   */
  @Override
  public double addTo(long key, double incrementValue)
  {
  ...
  public final class KeysContainer extends AbstractLongCollection 
    ...
    public <T extends LongProcedure> T forEach(final T procedure) {
      owner.forEach(new LongDoubleProcedure() {
        @Override
    ...
    public <T extends LongPredicate> T forEach(final T predicate) {
      owner.forEach(new LongDoublePredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractDoubleCollection {
    ...
    public int removeAll(final double e) {
      return owner.removeAll(new LongDoublePredicate() {
        @Override
        public boolean apply(long key, double value) {
