...
/**
 * A hash map of <code>Object</code> to <code>short</code>, implemented using open
             ...
             Cloneable
{
  ...
  public final class KeysContainer extends AbstractObjectCollection<KType> 
    ...
    private final ObjectShortHashMap<KType> owner = ObjectShortHashMap.this;
    ...
    public <T extends ObjectProcedure<? super KType>> T forEach(final T procedure) {
      owner.forEach(new ObjectShortProcedure<KType>() {
        @Override
    ...
    public <T extends ObjectPredicate<? super KType>> T forEach(final T predicate) {
      owner.forEach(new ObjectShortPredicate<KType>() {
        @Override
  ...
  private final class ValuesContainer extends AbstractShortCollection {
    ...
    public int removeAll(final short e) {
      return owner.removeAll(new ObjectShortPredicate<KType>() {
        @Override
        public boolean apply(KType key, short value) {
          return ((value) == (e));
        }
  ...
  public ObjectShortHashMap<KType> clone() {
    try {
      /*  */
      ObjectShortHashMap<KType> cloned = (ObjectShortHashMap<KType>) super.clone();
  ...
  public static <KType> ObjectShortHashMap<KType> from(KType[] keys, short[] values) {
    ...
    ObjectShortHashMap<KType> map = new ObjectShortHashMap<>(keys.length);
