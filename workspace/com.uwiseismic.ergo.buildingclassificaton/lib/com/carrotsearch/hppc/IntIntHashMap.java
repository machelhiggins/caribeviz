             ...
             Cloneable
{
   ...
   *          consequences.
   */
  public IntIntHashMap(int expectedElements, double loadFactor, HashOrderMixingStrategy orderMixer) {
  ...
  public final class KeysContainer extends AbstractIntCollection 
    ...
    public <T extends IntProcedure> T forEach(final T procedure) {
      owner.forEach(new IntIntProcedure() {
        @Override
    ...
    public <T extends IntPredicate> T forEach(final T predicate) {
      owner.forEach(new IntIntPredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractIntCollection {
    ...
    @Override
    public int removeAll(final int e) {
      return owner.removeAll(new IntIntPredicate() {
        @Override
        public boolean apply(int key, int value) {
          return ((value) == (e));
        }
