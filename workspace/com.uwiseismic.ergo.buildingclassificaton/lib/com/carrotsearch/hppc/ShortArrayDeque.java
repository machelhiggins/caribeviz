...
public class ShortArrayDeque 
  ...
  public 
        ...
        buffer = ShortArrayList.EMPTY_ARRAY;
   ...
   */
  private void descendingForEach(ShortProcedure procedure, int fromIndex, final int toIndex) {
   ...
   */
  private void descendingForEach(ShortPredicate predicate, int fromIndex, final int toIndex) {
    if (fromIndex == toIndex)
      return;
  ...
  protected boolean equalElements(ShortArrayDeque other) {
    ...
    Iterator<? extends ShortCursor> i2 = other.iterator();
