             ...
             Cloneable
{
   ...
   *          consequences.
   */
  public CharCharHashMap(int expectedElements, double loadFactor, HashOrderMixingStrategy orderMixer) {
  ...
  public final class KeysContainer extends AbstractCharCollection 
    ...
    private final CharCharHashMap owner = CharCharHashMap.this;
    ...
    public <T extends CharProcedure> T forEach(final T procedure) {
      owner.forEach(new CharCharProcedure() {
        @Override
    ...
    public <T extends CharPredicate> T forEach(final T predicate) {
      owner.forEach(new CharCharPredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractCharCollection {
    ...
    @Override
    public int removeAll(final char e) {
      return owner.removeAll(new CharCharPredicate() {
        @Override
        public boolean apply(char key, char value) {
          return ((value) == (e));
        }
   ...
   */
  @Override
  public CharCharHashMap clone() {
    try {
      /*  */
      CharCharHashMap cloned = (CharCharHashMap) super.clone();
   ...
   */
  public static  CharCharHashMap from(char[] keys, char[] values) {
    if (keys.length != values.length) {
      throw new IllegalArgumentException("Arrays of keys and values must have an identical length.");
    }

    CharCharHashMap map = new CharCharHashMap(keys.length);
