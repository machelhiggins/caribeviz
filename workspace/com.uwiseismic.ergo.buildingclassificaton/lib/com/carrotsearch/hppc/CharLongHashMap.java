             ...
             Cloneable
{
   ...
   *          consequences.
   */
  public CharLongHashMap(int expectedElements, double loadFactor, HashOrderMixingStrategy orderMixer) {
  ...
  public final class KeysContainer extends AbstractCharCollection 
    ...
    public <T extends CharProcedure> T forEach(final T procedure) {
      owner.forEach(new CharLongProcedure() {
        @Override
    ...
    public <T extends CharPredicate> T forEach(final T predicate) {
      owner.forEach(new CharLongPredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractLongCollection {
    ...
    public int removeAll(final long e) {
      return owner.removeAll(new CharLongPredicate() {
        @Override
        public boolean apply(char key, long value) {
          return ((value) == (e));
        }
