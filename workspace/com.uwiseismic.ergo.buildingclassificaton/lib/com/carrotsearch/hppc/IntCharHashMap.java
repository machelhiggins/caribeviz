             ...
             Cloneable
{
   ...
   *          consequences.
   */
  public IntCharHashMap(int expectedElements, double loadFactor, HashOrderMixingStrategy orderMixer) {
  ...
  public final class KeysContainer extends AbstractIntCollection 
    ...
    public <T extends IntProcedure> T forEach(final T procedure) {
      owner.forEach(new IntCharProcedure() {
        @Override
    ...
    public <T extends IntPredicate> T forEach(final T predicate) {
      owner.forEach(new IntCharPredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractCharCollection {
    ...
    public int removeAll(final char e) {
      return owner.removeAll(new IntCharPredicate() {
        @Override
        public boolean apply(int key, char value) {
          return ((value) == (e));
        }
