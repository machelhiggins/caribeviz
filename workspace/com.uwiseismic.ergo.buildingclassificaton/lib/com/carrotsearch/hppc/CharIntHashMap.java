             ...
             Cloneable
{
   ...
   *          consequences.
   */
  public CharIntHashMap(int expectedElements, double loadFactor, HashOrderMixingStrategy orderMixer) {
  ...
  public final class KeysContainer extends AbstractCharCollection 
    ...
    public <T extends CharProcedure> T forEach(final T procedure) {
      owner.forEach(new CharIntProcedure() {
        @Override
    ...
    public <T extends CharPredicate> T forEach(final T predicate) {
      owner.forEach(new CharIntPredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractIntCollection {
    ...
    public int removeAll(final int e) {
      return owner.removeAll(new CharIntPredicate() {
        @Override
        public boolean apply(char key, int value) {
          return ((value) == (e));
        }
