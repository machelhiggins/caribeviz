             ...
             Cloneable
{
  ...
  public final class KeysContainer extends AbstractCharCollection 
    ...
    private final CharDoubleHashMap owner = CharDoubleHashMap.this;
    ...
    public <T extends CharProcedure> T forEach(final T procedure) {
      owner.forEach(new CharDoubleProcedure() {
        @Override
    ...
    public <T extends CharPredicate> T forEach(final T predicate) {
      owner.forEach(new CharDoublePredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractDoubleCollection {
    ...
    public int removeAll(final double e) {
      return owner.removeAll(new CharDoublePredicate() {
        @Override
        public boolean apply(char key, double value) {
