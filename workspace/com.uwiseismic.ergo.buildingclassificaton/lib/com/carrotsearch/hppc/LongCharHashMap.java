             ...
             Cloneable
{
   ...
   *          consequences.
   */
  public LongCharHashMap(int expectedElements, double loadFactor, HashOrderMixingStrategy orderMixer) {
  ...
  public final class KeysContainer extends AbstractLongCollection 
    ...
    public <T extends LongProcedure> T forEach(final T procedure) {
      owner.forEach(new LongCharProcedure() {
        @Override
    ...
    public <T extends LongPredicate> T forEach(final T predicate) {
      owner.forEach(new LongCharPredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractCharCollection {
    ...
    public int removeAll(final char e) {
      return owner.removeAll(new LongCharPredicate() {
        @Override
        public boolean apply(long key, char value) {
          return ((value) == (e));
        }
