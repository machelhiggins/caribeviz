             ...
             Cloneable
{
   ...
   *          consequences.
   */
  public IntLongHashMap(int expectedElements, double loadFactor, HashOrderMixingStrategy orderMixer) {
   ...
   */
  public IntLongHashMap(IntLongAssociativeContainer container) {
    this(container.size());
    putAll(container);
  }
  ...
  public final class KeysContainer extends AbstractIntCollection 
    ...
    private final IntLongHashMap owner = IntLongHashMap.this;
    ...
    public <T extends IntProcedure> T forEach(final T procedure) {
      owner.forEach(new IntLongProcedure() {
        @Override
    ...
    public <T extends IntPredicate> T forEach(final T predicate) {
      owner.forEach(new IntLongPredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractLongCollection {
    ...
    public int removeAll(final long e) {
      return owner.removeAll(new IntLongPredicate() {
        @Override
        public boolean apply(int key, long value) {
          return ((value) == (e));
        }
