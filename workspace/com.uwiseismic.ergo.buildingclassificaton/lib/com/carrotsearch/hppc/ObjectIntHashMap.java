             ...
             Cloneable
{
  ...
  public final class KeysContainer extends AbstractObjectCollection<KType> 
    ...
    public <T extends ObjectProcedure<? super KType>> T forEach(final T procedure) {
      owner.forEach(new ObjectIntProcedure<KType>() {
        @Override
    ...
    public <T extends ObjectPredicate<? super KType>> T forEach(final T predicate) {
      owner.forEach(new ObjectIntPredicate<KType>() {
        @Override
  ...
  private final class ValuesContainer extends AbstractIntCollection {
    ...
    public int removeAll(final int e) {
      return owner.removeAll(new ObjectIntPredicate<KType>() {
        @Override
        public boolean apply(KType key, int value) {
          return ((value) == (e));
        }
