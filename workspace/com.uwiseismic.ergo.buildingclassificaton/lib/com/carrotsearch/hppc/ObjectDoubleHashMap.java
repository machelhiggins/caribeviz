...
/**
 * A hash map of <code>Object</code> to <code>double</code>, implemented using open
             ...
             Cloneable
{
  ...
  protected boolean equalElements(ObjectDoubleHashMap<?> other) {
    ...
    for (ObjectDoubleCursor<?> c : other) {
  ...
  public final class KeysContainer extends AbstractObjectCollection<KType> 
    ...
    private final ObjectDoubleHashMap<KType> owner = ObjectDoubleHashMap.this;
    ...
    public <T extends ObjectProcedure<? super KType>> T forEach(final T procedure) {
      owner.forEach(new ObjectDoubleProcedure<KType>() {
        @Override
    ...
    public <T extends ObjectPredicate<? super KType>> T forEach(final T predicate) {
      owner.forEach(new ObjectDoublePredicate<KType>() {
        @Override
  ...
  private final class ValuesContainer extends AbstractDoubleCollection {
    ...
    public int removeAll(final double e) {
      return owner.removeAll(new ObjectDoublePredicate<KType>() {
        @Override
        public boolean apply(KType key, double value) {
  ...
  public ObjectDoubleHashMap<KType> clone() {
    try {
      /*  */
      ObjectDoubleHashMap<KType> cloned = (ObjectDoubleHashMap<KType>) super.clone();
  ...
  public static <KType> ObjectDoubleHashMap<KType> from(KType[] keys, double[] values) {
    ...
    ObjectDoubleHashMap<KType> map = new ObjectDoubleHashMap<>(keys.length);
