             ...
             Cloneable
{
  ...
  public final class KeysContainer extends AbstractIntCollection 
    ...
    private final IntByteHashMap owner = IntByteHashMap.this;
    ...
    public <T extends IntProcedure> T forEach(final T procedure) {
      owner.forEach(new IntByteProcedure() {
        @Override
    ...
    public <T extends IntPredicate> T forEach(final T predicate) {
      owner.forEach(new IntBytePredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractByteCollection {
    ...
    public int removeAll(final byte e) {
      return owner.removeAll(new IntBytePredicate() {
        @Override
        public boolean apply(int key, byte value) {
          return ((value) == (e));
        }
