             ...
             Cloneable
{
   ...
   *          consequences.
   */
  public IntFloatHashMap(int expectedElements, double loadFactor, HashOrderMixingStrategy orderMixer) {
  ...
  public final class KeysContainer extends AbstractIntCollection 
    ...
    public <T extends IntProcedure> T forEach(final T procedure) {
      owner.forEach(new IntFloatProcedure() {
        @Override
    ...
    public <T extends IntPredicate> T forEach(final T predicate) {
      owner.forEach(new IntFloatPredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractFloatCollection {
    ...
    public int removeAll(final float e) {
      return owner.removeAll(new IntFloatPredicate() {
        @Override
        public boolean apply(int key, float value) {
