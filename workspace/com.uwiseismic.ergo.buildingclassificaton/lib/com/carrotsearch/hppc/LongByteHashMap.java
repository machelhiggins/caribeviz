             ...
             Cloneable
{
   ...
   *          consequences.
   */
  public LongByteHashMap(int expectedElements, double loadFactor, HashOrderMixingStrategy orderMixer) {
  ...
  public final class KeysContainer extends AbstractLongCollection 
    ...
    public <T extends LongProcedure> T forEach(final T procedure) {
      owner.forEach(new LongByteProcedure() {
        @Override
    ...
    public <T extends LongPredicate> T forEach(final T predicate) {
      owner.forEach(new LongBytePredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractByteCollection {
    ...
    public int removeAll(final byte e) {
      return owner.removeAll(new LongBytePredicate() {
        @Override
        public boolean apply(long key, byte value) {
          return ((value) == (e));
        }
