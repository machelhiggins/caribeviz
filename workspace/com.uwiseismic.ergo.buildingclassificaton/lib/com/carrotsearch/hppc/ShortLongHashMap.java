             ...
             Cloneable
{
  ...
  public final class KeysContainer extends AbstractShortCollection 
    ...
    private final ShortLongHashMap owner = ShortLongHashMap.this;
    ...
    public <T extends ShortProcedure> T forEach(final T procedure) {
      owner.forEach(new ShortLongProcedure() {
        @Override
    ...
    public <T extends ShortPredicate> T forEach(final T predicate) {
      owner.forEach(new ShortLongPredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractLongCollection {
    ...
    public int removeAll(final long e) {
      return owner.removeAll(new ShortLongPredicate() {
        @Override
        public boolean apply(short key, long value) {
          return ((value) == (e));
        }
