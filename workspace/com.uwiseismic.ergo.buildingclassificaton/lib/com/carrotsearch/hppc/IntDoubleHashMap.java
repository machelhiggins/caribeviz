             ...
             Cloneable
{
   ...
   *          consequences.
   */
  public IntDoubleHashMap(int expectedElements, double loadFactor, HashOrderMixingStrategy orderMixer) {
  ...
  public final class KeysContainer extends AbstractIntCollection 
    ...
    public <T extends IntProcedure> T forEach(final T procedure) {
      owner.forEach(new IntDoubleProcedure() {
        @Override
    ...
    public <T extends IntPredicate> T forEach(final T predicate) {
      owner.forEach(new IntDoublePredicate() {
        @Override
  ...
  private final class ValuesContainer extends AbstractDoubleCollection {
    ...
    public int removeAll(final double e) {
      return owner.removeAll(new IntDoublePredicate() {
        @Override
        public boolean apply(int key, double value) {
