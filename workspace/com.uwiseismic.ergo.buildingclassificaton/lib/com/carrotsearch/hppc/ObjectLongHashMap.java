...
/**
 * A hash map of <code>Object</code> to <code>long</code>, implemented using open
             ...
             Cloneable
{
   ...
   *          expansion (inclusive).
   */
  public ObjectLongHashMap(int expectedElements) {
   ...
   */
  public ObjectLongHashMap(int expectedElements, double loadFactor) {
  ...
  public final class KeysContainer extends AbstractObjectCollection<KType> 
    ...
    public <T extends ObjectProcedure<? super KType>> T forEach(final T procedure) {
      owner.forEach(new ObjectLongProcedure<KType>() {
        @Override
    ...
    public <T extends ObjectPredicate<? super KType>> T forEach(final T predicate) {
      owner.forEach(new ObjectLongPredicate<KType>() {
        @Override
  ...
  private final class ValuesContainer extends AbstractLongCollection {
    ...
    public int removeAll(final long e) {
      return owner.removeAll(new ObjectLongPredicate<KType>() {
        @Override
        public boolean apply(KType key, long value) {
          return ((value) == (e));
        }
