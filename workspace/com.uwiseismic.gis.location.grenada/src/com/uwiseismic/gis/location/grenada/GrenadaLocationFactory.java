...
public class GrenadaLocationFactory implements LocationFactory
{
    private final static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger( GrenadaLocationFactory.class );
    public final static String CITY = "Country";
    public final static String ENUMERATION_DISTRICT = "Enumeration District";

    public final static Grenada country = new Grenada();
    ...
    public List<? extends Location> getSubRegions( Location l )
    {
        ...
        if ( l.getType().equals( Grenada.TAG_SELF ) )
            return GrenadaUtils.getCities();
        if ( l.getType().equals( City.TAG_SELF ) )
            return GrenadaUtils.getDistrictsInCity( (City) l );
    ...
    public Location createLocationFromProperty( Property p ){    	
        return GrenadaUtils.createLocationFromProperty( p );
    }
