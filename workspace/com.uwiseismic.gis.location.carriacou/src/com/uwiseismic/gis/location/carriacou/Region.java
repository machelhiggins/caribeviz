...
public class Region extends AbstractLocation {
	...
	public City getCountry() {
		return CarriacouUtils.getCityFromCodeString(districtCode);
	}
	...
	public String getFullName() {
		...
		String fullName = name + " " + CarriacouLocationFactory.DISTRICT + ", "
				+ cityName + " " + CarriacouLocationFactory.CITY;
	...
	public Property asProperty() {
		return new Property(TAG_SELF, districtCode, Carriacou.ID, "location"); //$NON-NLS-1$ //$NON-NLS-2$
	}

	private void fromProperty(Property p) {
		//** Don't need property, this will have a unique id
        Region r = CarriacouUtils.getRegionFromCodeString( REGION_ID );
        name = r.getName();
