...
//						t = LocationUtils2.getEnumerationDistrictFromPostGIS(districtCode, cityCode);
	...
	public City getCity() {
		return TrinidadUtils.getCityFromCodeString(cityCode);
	}
	...
	public String getFullName() {
		...
		String fullName = name + " " + TrinidadLocationFactory.ENUMERATION_DISTRICT + ", "
				+ cityName + " " + TrinidadLocationFactory.CITY;
	...
	public Property asProperty() {
		return new Property(TAG_SELF, districtCode+","+cityCode, Trinidad.ID, "location"); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	private void fromProperty(Property p) {
		...
		City s = TrinidadUtils.getCityFromCodeString( cityCode );
        name = s.getName();
