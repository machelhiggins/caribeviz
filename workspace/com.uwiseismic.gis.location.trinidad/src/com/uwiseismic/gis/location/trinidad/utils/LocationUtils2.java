package com.uwiseismic.gis.location.trinidad.utils;
...
import com.uwiseismic.gis.location.trinidad.City;
import com.uwiseismic.gis.location.trinidad.EnumerationDistrict;
import com.uwiseismic.gis.location.trinidad.osgi.Activator;
...
//    }
    ...
    {
        Bundle bundle = Platform.getBundle( com.uwiseismic.gis.location.trinidad.osgi.Activator.PLUGIN_ID );
...
//        }
	    ...
	    Bundle bundle = Platform.getBundle( com.uwiseismic.gis.location.trinidad.osgi.Activator.PLUGIN_ID );
	    URL resourceURL = bundle.getResource( "regionShapefile/enumeration_district.shp" ); //$NON-NLS-1$
