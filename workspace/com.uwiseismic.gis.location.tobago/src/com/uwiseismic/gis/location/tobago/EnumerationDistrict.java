...
//						t = LocationUtils2.getEnumerationDistrictFromPostGIS(districtCode, cityCode);
	...
	public City getCity() {
		return TobagoUtils.getCityFromCodeString(cityCode);
	}
	...
	public String getFullName() {
		...
		String fullName = name + " " + TobagoLocationFactory.ENUMERATION_DISTRICT + ", "
				+ cityName + " " + TobagoLocationFactory.CITY;
	...
	public Property asProperty() {
		return new Property(TAG_SELF, districtCode+","+cityCode, Tobago.ID, "location"); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	private void fromProperty(Property p) {
		...
		City s = TobagoUtils.getCityFromCodeString( cityCode );
        name = s.getName();
