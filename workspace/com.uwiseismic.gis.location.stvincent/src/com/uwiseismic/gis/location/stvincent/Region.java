...
public class Region extends AbstractLocation {
	...
	public City getCountry() {
		return StvincentUtils.getCityFromCodeString(districtCode);
	}
	...
	public String getFullName() {
		...
		String fullName = name + " " + StVincentLocationFactory.DISTRICT + ", "
				+ cityName + " " + StVincentLocationFactory.CITY;
	...
	public Property asProperty() {
		return new Property(TAG_SELF, districtCode, StVincent.ID, "location"); //$NON-NLS-1$ //$NON-NLS-2$
	}

	private void fromProperty(Property p) {
		//** Don't need property, this will have a unique id
        Region r = StvincentUtils.getRegionFromCodeString( REGION_ID );
        name = r.getName();
