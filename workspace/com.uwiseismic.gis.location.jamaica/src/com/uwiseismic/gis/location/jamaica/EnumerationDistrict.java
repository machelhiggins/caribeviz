...
//						t = LocationUtils2.getEnumerationDistrictFromPostGIS(districtCode, cityCode);
	...
	public City getCity() {
		return JamaicaUtils.getCityFromCodeString(cityCode);
	}
	...
	public String getFullName() {
		...
		String fullName = name + " " + JamaicaLocationFactory.ENUMERATION_DISTRICT + ", "
				+ cityName + " " + JamaicaLocationFactory.CITY;
	...
	public Property asProperty() {
		return new Property(TAG_SELF, districtCode+","+cityCode, Jamaica.ID, "location"); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	private void fromProperty(Property p) {
		...
		City s = JamaicaUtils.getCityFromCodeString( cityCode );
        name = s.getName();
