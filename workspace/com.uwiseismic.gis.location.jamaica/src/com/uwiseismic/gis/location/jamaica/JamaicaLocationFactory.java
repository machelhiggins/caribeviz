...
import com.uwiseismic.gis.location.jamaica.utils.JamaicaUtils;
import com.uwiseismic.gis.location.jamaica.utils.LocationUtils2;
...
public class JamaicaLocationFactory implements LocationFactory
{
    private final static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger( JamaicaLocationFactory.class );
    public final static String CITY = "City";
    public final static String ENUMERATION_DISTRICT = "Enumeration District";

    public final static Jamaica country = new Jamaica();
    ...
    public List<? extends Location> getSubRegions( Location l )
    {
        ...
        if ( l.getType().equals( Jamaica.TAG_SELF ) )
            return JamaicaUtils.getCities();
        if ( l.getType().equals( City.TAG_SELF ) )
            return JamaicaUtils.getDistrictsInCity( (City) l );
    ...
    public Location createLocationFromProperty( Property p ){    	
        return JamaicaUtils.createLocationFromProperty( p );
    }
