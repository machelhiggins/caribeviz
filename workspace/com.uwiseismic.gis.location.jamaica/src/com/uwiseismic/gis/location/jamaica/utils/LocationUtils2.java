package com.uwiseismic.gis.location.jamaica.utils;
...
import com.uwiseismic.gis.location.jamaica.City;
import com.uwiseismic.gis.location.jamaica.EnumerationDistrict;
import com.uwiseismic.gis.location.jamaica.Jamaica;
...
//        	selectQuery.addSearchParameter(new SearchParameter("roi_id", Jamaica.REGION_ID, false));      
//        	
...
//    }
    ...
    {
        Bundle bundle = Platform.getBundle( com.uwiseismic.gis.location.jamaica.osgi.Activator.PLUGIN_ID );
...
//        if(districtsFC == null){
//            Bundle bundle = Platform.getBundle( ncsa.gis.location.jamaica.osgi.Activator.PLUGIN_ID );
...
//            //System.out.println("Total Features in this file :"+districtsFC.size());
//        }
//    	
...
//		Bundle bundle = Platform.getBundle(edu.illinois.ncsa.ergo.gis.location.turkey.osgi.Activator.PLUGIN_ID);
		Bundle bundle = Platform.getBundle( com.uwiseismic.gis.location.jamaica.osgi.Activator.PLUGIN_ID );
		URL resourceURL = bundle.getResource("regionShapefile/electoral_district.shp"); //$NON-NLS-1$
