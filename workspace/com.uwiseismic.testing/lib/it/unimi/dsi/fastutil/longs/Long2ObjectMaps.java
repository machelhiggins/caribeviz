...
public final class Long2ObjectMaps {
	...
	public static class Singleton<V> extends Long2ObjectFunctions.Singleton<V> implements Long2ObjectMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractLong2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class UnmodifiableMap<V> extends Long2ObjectFunctions.UnmodifiableFunction<V> implements Long2ObjectMap<V>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Long2ObjectMap<? extends V> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.long2ObjectEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public V getOrDefault(final long key, final V defaultValue) {
			return ((Long2ObjectMap<V>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <V> Long2ObjectMap<V> unmodifiable(final Long2ObjectMap<? extends V> m) {
