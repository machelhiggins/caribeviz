	...
	public LongSet keySet() {
		return new AbstractLongSet() {
			...
			public LongSpliterator spliterator() {
				return LongSpliterators.asSpliterator(iterator(), sizeOf(AbstractLong2ObjectMap.this), LongSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
	...
	public ObjectCollection<V> values() {
		return new AbstractObjectCollection<V>() {
			...
			public ObjectSpliterator<V> spliterator() {
				return ObjectSpliterators.asSpliterator(iterator(), sizeOf(AbstractLong2ObjectMap.this), ObjectSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
