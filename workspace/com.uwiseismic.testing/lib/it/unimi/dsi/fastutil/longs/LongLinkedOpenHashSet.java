...
public class LongLinkedOpenHashSet extends AbstractLongSortedSet implements java.io.Serializable, Cloneable, Hash {
	 ...
	 */
	public static LongLinkedOpenHashSet of(final long e) {
		LongLinkedOpenHashSet result = new LongLinkedOpenHashSet(1, DEFAULT_LOAD_FACTOR);
		result.add(e);
		return result;
	}
	 ...
	 */
	public static LongLinkedOpenHashSet of(final long e0, final long e1) {
		LongLinkedOpenHashSet result = new LongLinkedOpenHashSet(2, DEFAULT_LOAD_FACTOR);
		result.add(e0);
		if (!result.add(e1)) {
	 ...
	 * @throws IllegalArgumentException if there were duplicate entries.
	 */
	public static LongLinkedOpenHashSet of(final long e0, final long e1, final long e2) {
		LongLinkedOpenHashSet result = new LongLinkedOpenHashSet(3, DEFAULT_LOAD_FACTOR);
		result.add(e0);
		if (!result.add(e1)) {
			throw new IllegalArgumentException("Duplicate element: " + e1);
		}
	...
	public static LongLinkedOpenHashSet of(final long... a) {
		LongLinkedOpenHashSet result = new LongLinkedOpenHashSet(a.length, DEFAULT_LOAD_FACTOR);
		for (long element : a) {
	 ...
	 */
	public static LongLinkedOpenHashSet toSet(java.util.stream.LongStream stream) {
	 ...
	 *          {@code Collector} equivalent in the Java API.
	 */
	public static LongLinkedOpenHashSet toSetWithExpectedSize(java.util.stream.LongStream stream, int expectedSize) {
		...
		return stream.collect(new LongCollections.SizeDecreasingSupplier<LongLinkedOpenHashSet>(expectedSize, (int size) -> size <= Hash.DEFAULT_INITIAL_SIZE ? new LongLinkedOpenHashSet() : new LongLinkedOpenHashSet(size)), LongLinkedOpenHashSet::add, LongLinkedOpenHashSet::addAll);
	}
	 ...
	 * time.
	 */
	private final class SetIterator implements LongListIterator {
		/**
	...
	private static final int SPLITERATOR_CHARACTERISTICS = LongSpliterators.SET_SPLITERATOR_CHARACTERISTICS | java.util.Spliterator.ORDERED;
	...
	public LongSpliterator spliterator() {
		return LongSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(this), SPLITERATOR_CHARACTERISTICS);
	}
