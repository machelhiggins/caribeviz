 ...
 */
public class LongLongMutablePair implements LongLongPair, java.io.Serializable {
	 ...
	 */
	public LongLongMutablePair(final long left, final long right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static LongLongMutablePair of(final long left, final long right) {
	...
	@Override
	public LongLongMutablePair left(final long l) {
		left = l;
		return this;
	}
	...
	@Override
	public LongLongMutablePair right(final long r) {
		right = r;
		return this;
	}
