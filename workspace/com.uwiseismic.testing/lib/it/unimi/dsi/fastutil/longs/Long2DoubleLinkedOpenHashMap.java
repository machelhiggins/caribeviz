...
public class Long2DoubleLinkedOpenHashMap extends AbstractLong2DoubleSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Long2DoubleMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Long2DoubleMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Long2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractLongSortedSet {
		...
		public LongSpliterator spliterator() {
			return LongSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Long2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public DoubleCollection values() {
		if (values == null) values = new AbstractDoubleCollection() {
			...
			public DoubleSpliterator spliterator() {
				return DoubleSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Long2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
