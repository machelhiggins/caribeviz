...
public interface LongLongSortedPair extends LongLongPair, it.unimi.dsi.fastutil.SortedPair<Long>, java.io.Serializable {
	/**
	 ...
	 *           implementation.
	 */
	public static LongLongSortedPair of(final long left, final long right) {
	 ...
	 */
	default boolean contains(final long e) {
