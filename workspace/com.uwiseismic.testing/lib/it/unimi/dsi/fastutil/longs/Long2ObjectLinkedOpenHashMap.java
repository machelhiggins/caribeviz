...
public class Long2ObjectLinkedOpenHashMap<V> extends AbstractLong2ObjectSortedMap<V> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Long2ObjectMap.Entry<V>> implements FastSortedEntrySet<V> {
		...
		public ObjectSpliterator<Long2ObjectMap.Entry<V>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Long2ObjectLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractLongSortedSet {
		...
		public LongSpliterator spliterator() {
			return LongSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Long2ObjectLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
