	...
	*/
	...
	public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Long2IntMap.Entry>() {
			final Comparator<? super Long2IntMap.Entry> comparator = (Long2IntAVLTreeMap.this.actualComparator == null ? (Comparator<Long2IntMap.Entry>)(x, y) -> (Long.compare((x.getLongKey()), (y.getLongKey()))) : (Comparator<Long2IntMap.Entry>)(x, y) -> Long2IntAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey()));
