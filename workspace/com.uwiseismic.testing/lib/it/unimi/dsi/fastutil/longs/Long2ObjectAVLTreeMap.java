	...
	*/
	...
	public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>() {
			final Comparator<? super Long2ObjectMap.Entry<V>> comparator = (Long2ObjectAVLTreeMap.this.actualComparator == null ? (Comparator<Long2ObjectMap.Entry<V>>)(x, y) -> (Long.compare((x.getLongKey()), (y.getLongKey()))) : (Comparator<Long2ObjectMap.Entry<V>>)(x, y) -> Long2ObjectAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey()));
	...
	private final class Submap extends AbstractLong2ObjectSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2ObjectAVLTreeMap.this.compare(k, from) >= 0) && (top || Long2ObjectAVLTreeMap.this.compare(k, to) < 0);
		}
