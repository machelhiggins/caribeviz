...
public final class Long2ObjectSortedMaps {
	...
	public static class Singleton<V> extends Long2ObjectMaps.Singleton<V> implements Long2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2ObjectMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<V> extends Long2ObjectMaps.SynchronizedMap<V> implements Long2ObjectSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.long2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Long2ObjectMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Long2ObjectMaps.UnmodifiableMap<V> implements Long2ObjectSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Long2ObjectSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.long2ObjectEntrySet());
			return (ObjectSortedSet<Long2ObjectMap.Entry<V>>)entries;
		}
	 ...
	 */
	public static <V> Long2ObjectSortedMap<V> unmodifiable(final Long2ObjectSortedMap<? extends V> m) {
