	...
	*/
	...
	public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>() {
			final Comparator<? super Long2DoubleMap.Entry> comparator = (Long2DoubleAVLTreeMap.this.actualComparator == null ? (Comparator<Long2DoubleMap.Entry>)(x, y) -> (Long.compare((x.getLongKey()), (y.getLongKey()))) : (Comparator<Long2DoubleMap.Entry>)(x, y) -> Long2DoubleAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey()));
	...
	private final class Submap extends AbstractLong2DoubleSortedMap implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2DoubleAVLTreeMap.this.compare(k, from) >= 0) && (top || Long2DoubleAVLTreeMap.this.compare(k, to) < 0);
		}
