...
public final class Long2IntSortedMaps {
	...
	public static class Singleton extends Long2IntMaps.Singleton implements Long2IntSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2IntMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Long2IntMaps.SynchronizedMap implements Long2IntSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.long2IntEntrySet(), sync);
			return (ObjectSortedSet<Long2IntMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Long2IntMaps.UnmodifiableMap implements Long2IntSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.long2IntEntrySet());
			return (ObjectSortedSet<Long2IntMap.Entry>)entries;
		}
