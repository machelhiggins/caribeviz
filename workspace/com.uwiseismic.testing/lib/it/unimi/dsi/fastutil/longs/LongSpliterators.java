...
public final class LongSpliterators {
	 ...
	 *         position {@code offset}.
	 */
	public static LongSpliterator wrapPreSorted(final long[] array, final int offset, final int length, final int additionalCharacteristics, LongComparator comparator) {
		LongArrays.ensureOffsetLength(array, offset, length);
	 ...
	 *         position {@code offset}.
	 */
	public static LongSpliterator wrapPreSorted(final long[] array, final int offset, final int length, LongComparator comparator) {
	 ...
	 *         position {@code offset}.
	 */
	public static LongSpliterator wrapPreSorted(final long[] array, LongComparator comparator) {
	 ...
	 *         return.
	 */
	public static LongSpliterator asSpliteratorFromSorted(final LongIterator iter, final long size, final int additionalCharacterisitcs, final LongComparator comparator) {
