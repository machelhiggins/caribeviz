 ...
 */
public interface LongLongPair extends it.unimi.dsi.fastutil.Pair<Long, Long> {
	/**
	 ...
	 */
	public default LongLongPair left(final long l) {
	 ...
	 */
	public default LongLongPair first(final long l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default LongLongPair key(final long l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default LongLongPair key(Long l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default LongLongPair right(final long r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default LongLongPair right(final Long l) {
	 ...
	 */
	public default LongLongPair second(final long r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default LongLongPair second(final Long l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default LongLongPair value(final long r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default LongLongPair value(final Long l) {
	 ...
	 */
	public static LongLongPair of(final long left, final long right) {
	...
	public static java.util.Comparator<LongLongPair> lexComparator() {
		return (x, y) -> {
