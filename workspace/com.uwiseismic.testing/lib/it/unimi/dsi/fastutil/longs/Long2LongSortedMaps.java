...
public final class Long2LongSortedMaps {
	...
	public static class Singleton extends Long2LongMaps.Singleton implements Long2LongSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractLong2LongMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Long2LongMaps.SynchronizedMap implements Long2LongSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.long2LongEntrySet(), sync);
			return (ObjectSortedSet<Long2LongMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Long2LongMaps.UnmodifiableMap implements Long2LongSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.long2LongEntrySet());
			return (ObjectSortedSet<Long2LongMap.Entry>)entries;
		}
