...
public class Long2IntLinkedOpenHashMap extends AbstractLong2IntSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Long2IntMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Long2IntMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Long2IntLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	 ...
	 */
	private final class KeyIterator extends MapIterator<java.util.function.LongConsumer> implements LongListIterator {
	...
	private final class KeySet extends AbstractLongSortedSet {
		...
		public LongSpliterator spliterator() {
			return LongSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Long2IntLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public IntCollection values() {
		if (values == null) values = new AbstractIntCollection() {
			...
			public IntSpliterator spliterator() {
				return IntSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Long2IntLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
