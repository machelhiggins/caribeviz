...
public interface Long2IntFunction extends Function<Long, Integer>, java.util.function.LongToIntFunction {
	...
	default it.unimi.dsi.fastutil.longs.Long2ByteFunction andThenByte(it.unimi.dsi.fastutil.ints.Int2ByteFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2IntFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2LongFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2ShortFunction andThenShort(it.unimi.dsi.fastutil.ints.Int2ShortFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2IntFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2LongFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2IntFunction andThenInt(it.unimi.dsi.fastutil.ints.Int2IntFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2IntFunction composeInt(it.unimi.dsi.fastutil.ints.Int2LongFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2LongFunction andThenLong(it.unimi.dsi.fastutil.ints.Int2LongFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2IntFunction composeLong(it.unimi.dsi.fastutil.longs.Long2LongFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2CharFunction andThenChar(it.unimi.dsi.fastutil.ints.Int2CharFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2IntFunction composeChar(it.unimi.dsi.fastutil.chars.Char2LongFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2FloatFunction andThenFloat(it.unimi.dsi.fastutil.ints.Int2FloatFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2IntFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2LongFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.ints.Int2DoubleFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2IntFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2LongFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.longs.Long2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.ints.Int2ObjectFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2IntFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2LongFunction<? super T> before) {
		return k -> get(before.getLong(k));
	}

	default <T> it.unimi.dsi.fastutil.longs.Long2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.ints.Int2ReferenceFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2IntFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2LongFunction<? super T> before) {
		return k -> get(before.getLong(k));
	}
}
