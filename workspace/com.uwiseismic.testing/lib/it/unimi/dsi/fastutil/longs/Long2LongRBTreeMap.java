...
public class Long2LongRBTreeMap extends AbstractLong2LongSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Long2LongMap.Entry>() {
			final Comparator<? super Long2LongMap.Entry> comparator = (Long2LongRBTreeMap.this.actualComparator == null ? (Comparator<Long2LongMap.Entry>)(x, y) -> (Long.compare((x.getLongKey()), (y.getLongKey()))) : (Comparator<Long2LongMap.Entry>)(x, y) -> Long2LongRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey()));
	...
	private final class Submap extends AbstractLong2LongSortedMap implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2LongRBTreeMap.this.compare(k, from) >= 0) && (top || Long2LongRBTreeMap.this.compare(k, to) < 0);
		}
