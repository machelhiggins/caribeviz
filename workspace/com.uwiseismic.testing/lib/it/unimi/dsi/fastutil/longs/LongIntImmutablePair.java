 ...
 */
public class LongIntImmutablePair implements LongIntPair, java.io.Serializable {
	 ...
	 */
	public LongIntImmutablePair(final long left, final int right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static LongIntImmutablePair of(final long left, final int right) {
