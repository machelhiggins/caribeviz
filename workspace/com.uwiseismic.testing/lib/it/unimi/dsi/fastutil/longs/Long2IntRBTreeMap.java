...
public class Long2IntRBTreeMap extends AbstractLong2IntSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Long2IntMap.Entry>() {
			final Comparator<? super Long2IntMap.Entry> comparator = (Long2IntRBTreeMap.this.actualComparator == null ? (Comparator<Long2IntMap.Entry>)(x, y) -> (Long.compare((x.getLongKey()), (y.getLongKey()))) : (Comparator<Long2IntMap.Entry>)(x, y) -> Long2IntRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey()));
	...
	private final class Submap extends AbstractLong2IntSortedMap implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2IntRBTreeMap.this.compare(k, from) >= 0) && (top || Long2IntRBTreeMap.this.compare(k, to) < 0);
		}
