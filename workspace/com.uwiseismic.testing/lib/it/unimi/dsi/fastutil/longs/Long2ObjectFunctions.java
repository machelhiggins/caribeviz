...
public final class Long2ObjectFunctions {
	...
	public static class UnmodifiableFunction<V> extends AbstractLong2ObjectFunction<V> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Long2ObjectFunction<? extends V> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public V getOrDefault(final long k, final V defaultValue) {
			return ((Long2ObjectFunction<V>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <V> Long2ObjectFunction<V> unmodifiable(final Long2ObjectFunction<? extends V> f) {
	...
	public static <V> Long2ObjectFunction<V> primitive(final java.util.function.Function<? super Long, ? extends V> f) {
		...
		if (f instanceof java.util.function.LongFunction) return ((java.util.function.LongFunction<V>)f)::apply;
