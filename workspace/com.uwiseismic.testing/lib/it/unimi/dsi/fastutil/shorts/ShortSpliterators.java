...
public final class ShortSpliterators {
	 ...
	 */
	public static class EmptySpliterator implements ShortSpliterator, java.io.Serializable, Cloneable {
		...
		@Deprecated
		@Override
		public boolean tryAdvance(final Consumer<? super Short> action) {
			return false;
		}
	 ...
	 *
	 * <p>
	 * The class of this objects represent an abstract empty spliterator that can iterate as a
	 * type-specific spliterator.
	 */
	...
	private static class SingletonSpliterator implements ShortSpliterator {
		...
		private static final int CHARACTERISTICS = BASE_SPLITERATOR_CHARACTERISTICS | Spliterator.SIZED | Spliterator.SUBSIZED | Spliterator.ORDERED | Spliterator.DISTINCT | Spliterator.SORTED | Spliterator.IMMUTABLE;

		public SingletonSpliterator(final short element) {
			this(element, null);
		}

		public SingletonSpliterator(final short element, final ShortComparator comparator) {
	 ...
	 */
	public static ShortSpliterator singleton(final short element) {
	 ...
	 * @return a spliterator that iterates just over {@code element}.
	 */
	public static ShortSpliterator singleton(final short element, final ShortComparator comparator) {
	...
	private static class ArraySpliterator implements ShortSpliterator {
		...
		public ArraySpliterator(final short[] array, final int offset, final int length, int additionalCharacteristics) {
			this.array = array;
			this.offset = offset;
			this.length = length;
	...
	private static class ArraySpliteratorWithComparator extends ArraySpliterator {
		...
		public ArraySpliteratorWithComparator(final short[] array, final int offset, final int length, int additionalCharacteristics, final ShortComparator comparator) {
	 ...
	 */
	public static ShortSpliterator wrap(final short[] array, final int offset, final int length) {
	 ...
	 */
	public static ShortSpliterator wrap(final short[] array) {
	 ...
	 *         position {@code offset}.
	 */
	public static ShortSpliterator wrap(final short[] array, final int offset, final int length, final int additionalCharacteristics) {
		ShortArrays.ensureOffsetLength(array, offset, length);
	 ...
	 *         position {@code offset}.
	 */
	public static ShortSpliterator wrapPreSorted(final short[] array, final int offset, final int length, final int additionalCharacteristics, ShortComparator comparator) {
		ShortArrays.ensureOffsetLength(array, offset, length);
	 ...
	 *         position {@code offset}.
	 */
	public static ShortSpliterator wrapPreSorted(final short[] array, final int offset, final int length, ShortComparator comparator) {
	 ...
	 *         position {@code offset}.
	 */
	public static ShortSpliterator wrapPreSorted(final short[] array, ShortComparator comparator) {
		return wrapPreSorted(array, 0, array.length, comparator);
	}

	// There is no non-comparator version of wrapPreSorted; because Spliterator has to return the
	// Comparator
	...
	private static class SpliteratorWrapper implements ShortSpliterator {
		...
		public SpliteratorWrapper(final Spliterator<Short> i) {
			this.i = i;
		}
		...
		@Override
		public ShortComparator getComparator() {
			return ShortComparators.asShortComparator(i.getComparator());
		}

		@Override
		public ShortSpliterator trySplit() {
			Spliterator<Short> innerSplit = i.trySplit();
	...
	private static class SpliteratorWrapperWithComparator extends SpliteratorWrapper {
		...
		public SpliteratorWrapperWithComparator(final Spliterator<Short> i, final ShortComparator comparator) {
			super(i);
			this.comparator = comparator;
		}
	...
	private static class PrimitiveSpliteratorWrapper implements ShortSpliterator {
		...
		public ShortComparator getComparator() {
			...
			final java.util.Comparator<? super Integer> comp = i.getComparator();
			return (short left, short right) -> comp.compare(Integer.valueOf(left), Integer.valueOf(right));
		}
	...
	private static class PrimitiveSpliteratorWrapperWithComparator extends PrimitiveSpliteratorWrapper {
		...
		public PrimitiveSpliteratorWrapperWithComparator(final Spliterator.OfInt i, final ShortComparator comparator) {
			super(i);
			this.comparator = comparator;
		}
	...
	public static ShortSpliterator asShortSpliterator(final Spliterator i) {
		if (i instanceof ShortSpliterator) return (ShortSpliterator)i;
	 ...
	 *
	 * <p>
	 * <b>NOTE:</b>This is mostly intended for supporting default implementations in interfaces that
	 ...
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static ShortSpliterator asShortSpliterator(final Spliterator i, final ShortComparator comparatorOverride) {
		if (i instanceof ShortSpliterator) throw new IllegalArgumentException("Cannot override comparator on instance that is already a " + ShortSpliterator.class.getSimpleName());
	 ...
	 * <p>
	 * The {@code tryAdvance} method throws {@link IllegalArgumentException} if any element would
	 * underflow or overflow.
	 *
	 * @param i a spiterator
	 * @return a type-specific spliterator backed by {@code i}
	 */
	public static ShortSpliterator narrow(final Spliterator.OfInt i) {
	 ...
	 */
	public static void onEachMatching(final ShortSpliterator spliterator, final ShortPredicate predicate, final ShortConsumer action) {
		Objects.requireNonNull(predicate);
		Objects.requireNonNull(action);
		spliterator.forEachRemaining((short value) -> {
	 ...
	 * potential for parallelism).
	 */
	public static void onEachMatching(final ShortSpliterator spliterator, final java.util.function.IntPredicate predicate, final java.util.function.IntConsumer action) {
		Objects.requireNonNull(predicate);
		Objects.requireNonNull(action);
		// No lambda introduction here; this isn't overrideable (static method) and widening casts are
		// implicit.
		spliterator.forEachRemaining((short value) -> {
			if (predicate.test(value)) {
				action.accept(value);
	...
	public static abstract class AbstractIndexBasedSpliterator extends AbstractShortSpliterator {
		 ...
		 *
		 * <p>
		 * Do <em>not</em> advance {@link #pos} in this method; the default {@link #tryAdvance} and
		 ...
		 */
		protected abstract short get(int location);
		 ...
		 *
		 * <p>
		 * Do <em>not</em> modify {@link #pos} in this method; the default {@link #trySplit()} method takes
		 * care of this.
		 *
		 * <p>
		 ...
		 */
		protected abstract ShortSpliterator makeForSplit(int pos, int maxPos);
	 ...
	 * time and then be fixed for the remaining duration of this instance.<br>
	...
	private static class IntervalSpliterator implements ShortSpliterator {
		...
		private static final int CHARACTERISTICS = BASE_SPLITERATOR_CHARACTERISTICS | Spliterator.SIZED | Spliterator.SUBSIZED | Spliterator.ORDERED | Spliterator.DISTINCT | Spliterator.SORTED | Spliterator.IMMUTABLE;
		private short curr, to;

		public IntervalSpliterator(final short from, final short to) {
			this.curr = from;
			this.to = to;
		}
		...
		public ShortSpliterator trySplit() {
			...
			short mid = (short)(curr + (remaining >> 1));
		...
		public long skip(long n) {
			...
			if (newCurr <= to && newCurr >= curr) {
				curr = it.unimi.dsi.fastutil.SafeMath.safeLongToShort(newCurr);
				return n;
			}
			n = to - curr;
			curr = to;
	 ...
	 *
	 * <p>
	 * The type-specific spliterator returned by this method will return the elements {@code from},
	 ...
	 */
	public static ShortSpliterator fromTo(final short from, final short to) {
	...
	private static class SpliteratorConcatenator implements ShortSpliterator {
		...
		// Neither SORTED nor DISTINCT "combine". Two combined spliterators with these characteristics may
		// not have it.
		...
		public SpliteratorConcatenator(final ShortSpliterator a[], int offset, int length) {
			this.a = a;
			this.offset = offset;
			this.length = length;
		...
		public ShortSpliterator trySplit() {
			...
			case 1: {
				...
				ShortSpliterator split = a[offset].trySplit();
			...
			case 2: {
				...
				ShortSpliterator split = a[offset++];
				--length;
				// assert length == 1;
	 ...
	 */
	public static ShortSpliterator concat(final ShortSpliterator... a) {
	 ...
	 *         at {@code offset}.
	 */
	public static ShortSpliterator concat(final ShortSpliterator a[], final int offset, final int length) {
	...
	private static class SpliteratorFromIterator implements ShortSpliterator {
		...
		SpliteratorFromIterator(final ShortIterator iter, int characteristics) {
			this.iter = iter;
			this.characteristics = BASE_SPLITERATOR_CHARACTERISTICS | characteristics;
			knownSize = false;
		}

		SpliteratorFromIterator(final ShortIterator iter, long size, int additionalCharacteristics) {
			this.iter = iter;
			knownSize = true;
			this.size = size;
		...
		public ShortSpliterator trySplit() {
			...
			while (actualSeen < batchSizeEst && iter.hasNext()) {
				batch[actualSeen++] = iter.nextShort();
				--size;
			}
			// Check if the local size variable fell behind the backing source, and if so, fill up remaining of
			// batch
		...
		public long skip(long n) {
			if (n < 0) throw new IllegalArgumentException("Argument must be nonnegative: " + n);
			if (iter instanceof ShortBigListIterator) {
				long skipped = ((ShortBigListIterator)iter).skip(n);
				size -= skipped;
				return skipped;
			} else {
				long skippedSoFar = 0;
	...
	private static class SpliteratorFromIteratorWithComparator extends SpliteratorFromIterator {
		...
		SpliteratorFromIteratorWithComparator(final ShortIterator iter, int additionalCharacteristics, final ShortComparator comparator) {
			super(iter, additionalCharacteristics | SORTED_CHARACTERISTICS);
			this.comparator = comparator;
		}

		SpliteratorFromIteratorWithComparator(final ShortIterator iter, long size, int additionalCharacteristics, final ShortComparator comparator) {
	 ...
	 */
	public static ShortSpliterator asSpliterator(final ShortIterator iter, final long size, final int additionalCharacterisitcs) {
	 ...
	 *         return.
	 */
	public static ShortSpliterator asSpliteratorFromSorted(final ShortIterator iter, final long size, final int additionalCharacterisitcs, final ShortComparator comparator) {
	 ...
	 */
	public static ShortSpliterator asSpliteratorUnknownSize(final ShortIterator iter, final int characterisitcs) {
	 ...
	 *         return.
	 */
	public static ShortSpliterator asSpliteratorFromSortedUnknownSize(final ShortIterator iter, final int additionalCharacterisitcs, final ShortComparator comparator) {
	...
	private static final class IteratorFromSpliterator implements ShortIterator, ShortConsumer {
		...
		private short holder = ((short)0);
		/** Whether we have an element "peeked" from a hasNext that we have yet to return */
		private boolean hasPeeked = false;

		IteratorFromSpliterator(final ShortSpliterator spliterator) {
			this.spliterator = spliterator;
		}

		@Override
		public void accept(final short item) {
			holder = item;
		}
	 ...
	 */
	public static ShortIterator asIterator(final ShortSpliterator spliterator) {
	 ...
	 *
	 * <p>
	 * Note: Due to the incompatibility of primitive {@link Comparator} types, the returned
	 * spliterator's {@link Spliterator#getComparator()} will always throw
	 * {@link IllegalStateException}, even when the underlying spliterator is
	 * {@linkplain Spliterator#SORTED sorted}.
	 *
	 * @param spliterator a byte spliterator.
	 * @return a spliterator backed by the specified byte spliterator.
	 */
	public static ShortSpliterator wrap(final it.unimi.dsi.fastutil.bytes.ByteSpliterator spliterator) {
