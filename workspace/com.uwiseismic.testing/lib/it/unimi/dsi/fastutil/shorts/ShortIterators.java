...
public final class ShortIterators {
	...
	public static long unwrap(final ShortIterator i, final short array[][], long offset, final long max) {
		...
		long j = max;
		while (j-- != 0 && i.hasNext()) set(array, offset++, i.nextShort());
		return max - j - 1;
	}
	...
	private static class CheckedPrimitiveIteratorWrapper extends PrimitiveIteratorWrapper {
		...
		@Override
		public short nextShort() {
			return it.unimi.dsi.fastutil.SafeMath.safeIntToShort(i.nextInt());
		}

		@Override
		public void forEachRemaining(final ShortConsumer action) {
			i.forEachRemaining((java.util.function.IntConsumer)(int value) -> {
				action.accept(it.unimi.dsi.fastutil.SafeMath.safeIntToShort(value));
			});
		}
	}
	...
	public static boolean any(final ShortIterator iterator, final java.util.function.IntPredicate predicate) {
		return any(iterator, predicate instanceof ShortPredicate ? (ShortPredicate)predicate : (ShortPredicate)predicate::test);
	}
	...
	public static boolean all(final ShortIterator iterator, final java.util.function.IntPredicate predicate) {
		return all(iterator, predicate instanceof ShortPredicate ? (ShortPredicate)predicate : (ShortPredicate)predicate::test);
	}
	...
	public static int indexOf(final ShortIterator iterator, final java.util.function.IntPredicate predicate) {
		return indexOf(iterator, predicate instanceof ShortPredicate ? (ShortPredicate)predicate : (ShortPredicate)predicate::test);
	}
	...
	public static abstract class AbstractIndexBasedListIterator extends AbstractIndexBasedIterator implements ShortListIterator {
		 ...
		 */
		protected abstract void add(int location, short k);
		 ...
		 * See {@link #pos} and {@link #get(int)} for discussion on what the location means.
		 */
		protected abstract void set(int location, short k);
	...
	private final static class ByteIteratorWrapper implements ShortIterator {
