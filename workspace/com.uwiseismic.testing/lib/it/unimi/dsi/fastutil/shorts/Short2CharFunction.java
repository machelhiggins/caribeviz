...
public interface Short2CharFunction extends Function<Short, Character>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.shorts.Short2ByteFunction andThenByte(it.unimi.dsi.fastutil.chars.Char2ByteFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2CharFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2ShortFunction andThenShort(it.unimi.dsi.fastutil.chars.Char2ShortFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2CharFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2IntFunction andThenInt(it.unimi.dsi.fastutil.chars.Char2IntFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2CharFunction composeInt(it.unimi.dsi.fastutil.ints.Int2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2LongFunction andThenLong(it.unimi.dsi.fastutil.chars.Char2LongFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2CharFunction composeLong(it.unimi.dsi.fastutil.longs.Long2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2CharFunction andThenChar(it.unimi.dsi.fastutil.chars.Char2CharFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2CharFunction composeChar(it.unimi.dsi.fastutil.chars.Char2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2FloatFunction andThenFloat(it.unimi.dsi.fastutil.chars.Char2FloatFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2CharFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.chars.Char2DoubleFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2CharFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.shorts.Short2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.chars.Char2ObjectFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2CharFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2ShortFunction<? super T> before) {
		return k -> get(before.getShort(k));
	}

	default <T> it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.chars.Char2ReferenceFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2CharFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2ShortFunction<? super T> before) {
		return k -> get(before.getShort(k));
	}
}
