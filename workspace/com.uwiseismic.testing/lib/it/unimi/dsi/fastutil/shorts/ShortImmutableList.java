 ...
 * expensive loops.
 */
public class ShortImmutableList extends ShortLists.ImmutableListBase implements ShortList, RandomAccess, Cloneable, java.io.Serializable {
	...
	public short[] toShortArray() {
		if (a.length == 0) return ShortArrays.EMPTY_ARRAY;
		return a.clone();
	}

	@Override
	public short[] toArray(short[] a) {
		if (a == null || a.length < size()) a = new short[this.a.length];
	...
	private final class Spliterator implements ShortSpliterator {
		...
		public int characteristics() {
			return ShortSpliterators.LIST_SPLITERATOR_CHARACTERISTICS | java.util.Spliterator.IMMUTABLE;
		}
	...
	private final static class ImmutableSubList extends ShortLists.ImmutableListBase implements java.util.RandomAccess, java.io.Serializable {
