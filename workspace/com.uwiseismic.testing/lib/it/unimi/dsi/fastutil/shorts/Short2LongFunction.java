...
public interface Short2LongFunction extends Function<Short, Long>, java.util.function.IntToLongFunction {
	...
	default it.unimi.dsi.fastutil.shorts.Short2ByteFunction andThenByte(it.unimi.dsi.fastutil.longs.Long2ByteFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2LongFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2ShortFunction andThenShort(it.unimi.dsi.fastutil.longs.Long2ShortFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2LongFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2IntFunction andThenInt(it.unimi.dsi.fastutil.longs.Long2IntFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2LongFunction composeInt(it.unimi.dsi.fastutil.ints.Int2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2LongFunction andThenLong(it.unimi.dsi.fastutil.longs.Long2LongFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2LongFunction composeLong(it.unimi.dsi.fastutil.longs.Long2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2CharFunction andThenChar(it.unimi.dsi.fastutil.longs.Long2CharFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2LongFunction composeChar(it.unimi.dsi.fastutil.chars.Char2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2FloatFunction andThenFloat(it.unimi.dsi.fastutil.longs.Long2FloatFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2LongFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.longs.Long2DoubleFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2LongFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2ShortFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.shorts.Short2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.longs.Long2ObjectFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2LongFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2ShortFunction<? super T> before) {
		return k -> get(before.getShort(k));
	}

	default <T> it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.longs.Long2ReferenceFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2LongFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2ShortFunction<? super T> before) {
		return k -> get(before.getShort(k));
	}
}
