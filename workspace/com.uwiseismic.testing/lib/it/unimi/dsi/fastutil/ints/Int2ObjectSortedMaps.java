...
public final class Int2ObjectSortedMaps {
	...
	public static class Singleton<V> extends Int2ObjectMaps.Singleton<V> implements Int2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2ObjectMap.BasicEntry<>(key, value), entryComparator(comparator));
		...
		@Override
		public IntSortedSet keySet() {
			if (keys == null) keys = IntSortedSets.singleton(key, comparator);
	...
	public static class SynchronizedSortedMap<V> extends Int2ObjectMaps.SynchronizedMap<V> implements Int2ObjectSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.int2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Int2ObjectMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Int2ObjectMaps.UnmodifiableMap<V> implements Int2ObjectSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Int2ObjectSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.int2ObjectEntrySet());
			return (ObjectSortedSet<Int2ObjectMap.Entry<V>>)entries;
		}
