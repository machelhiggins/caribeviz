...
public final class Int2DoubleSortedMaps {
	...
	public static class Singleton extends Int2DoubleMaps.Singleton implements Int2DoubleSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2DoubleMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Int2DoubleMaps.SynchronizedMap implements Int2DoubleSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.int2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Int2DoubleMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2DoubleMaps.UnmodifiableMap implements Int2DoubleSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.int2DoubleEntrySet());
			return (ObjectSortedSet<Int2DoubleMap.Entry>)entries;
		}
