...
import static it.unimi.dsi.fastutil.ints.IntArrayFrontCodedList.count;
import static it.unimi.dsi.fastutil.ints.IntArrayFrontCodedList.readInt;
import static it.unimi.dsi.fastutil.ints.IntArrayFrontCodedList.writeInt;
...
public class IntArrayFrontCodedBigList extends AbstractObjectBigList<int[]> implements Serializable, Cloneable, RandomAccess {
	 ...
	 */
	public IntArrayFrontCodedBigList(final Iterator<int[]> arrays, final int ratio) {
	 ...
	 * @param ratio the desired ratio.
	 */
	public IntArrayFrontCodedBigList(final Collection<int[]> c, final int ratio) {
	 ...
	 */
	private int extract(final long index, final int a[], final int offset, final int length) {
	 ...
	 */
	public int[] getArray(final long index) {
		ensureRestrictedIndex(index);
	 ...
	 */
	public int get(final long index, final int[] a, final int offset, final int length) {
		ensureRestrictedIndex(index);
	 ...
	 *         otherwise, the number of remaining elements with the sign changed.
	 */
	public int get(final long index, final int[] a) {
	...
	public void dump(java.io.DataOutputStream array, java.io.DataOutputStream pointers) throws java.io.IOException {
		for (int[] s : this.array) for (int e : s) array.writeInt(e);
