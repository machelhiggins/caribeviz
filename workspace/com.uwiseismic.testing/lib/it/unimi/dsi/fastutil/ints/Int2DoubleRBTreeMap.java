...
public class Int2DoubleRBTreeMap extends AbstractInt2DoubleSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>() {
			final Comparator<? super Int2DoubleMap.Entry> comparator = (Int2DoubleRBTreeMap.this.actualComparator == null ? (Comparator<Int2DoubleMap.Entry>)(x, y) -> (Integer.compare((x.getIntKey()), (y.getIntKey()))) : (Comparator<Int2DoubleMap.Entry>)(x, y) -> Int2DoubleRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey()));
	...
	private final class Submap extends AbstractInt2DoubleSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2DoubleRBTreeMap.this.compare(k, from) >= 0) && (top || Int2DoubleRBTreeMap.this.compare(k, to) < 0);
		}
