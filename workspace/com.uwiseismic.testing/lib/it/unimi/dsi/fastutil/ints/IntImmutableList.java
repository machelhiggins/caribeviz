 ...
 * expensive loops.
 */
public class IntImmutableList extends IntLists.ImmutableListBase implements IntList, RandomAccess, Cloneable, java.io.Serializable {
	...
	/**
	 * Collects the result of a primitive {@code Stream} into a new ImmutableList, potentially
	 * pre-allocated to handle the given size.
	 *
	 * <p>
	 * This method performs a terminal operation on the given {@code Stream}
	 *
	 ...
	 *          {@code Collector} equivalent in the Java API.
	 */
	public static IntImmutableList toListWithExpectedSize(java.util.stream.IntStream stream, int expectedSize) {
	...
	public int[] toIntArray() {
		if (a.length == 0) return IntArrays.EMPTY_ARRAY;
		return a.clone();
	}

	@Override
	public int[] toArray(int[] a) {
		if (a == null || a.length < size()) a = new int[this.a.length];
	...
	private final static class ImmutableSubList extends IntLists.ImmutableListBase implements java.util.RandomAccess, java.io.Serializable {
