 ...
 */
public class IntIntImmutableSortedPair extends IntIntImmutablePair implements IntIntSortedPair, java.io.Serializable {
	...
	public static IntIntImmutableSortedPair of(final int left, final int right) {
		if (left <= right) return new IntIntImmutableSortedPair(left, right);
		else return new IntIntImmutableSortedPair(right, left);
	}
	...
	public boolean equals(Object other) {
		...
		if (other instanceof IntIntSortedPair) {
			return left == ((IntIntSortedPair)other).leftInt() && right == ((IntIntSortedPair)other).rightInt();
		}
		if (other instanceof it.unimi.dsi.fastutil.SortedPair) {
			return java.util.Objects.equals(Integer.valueOf(left), ((it.unimi.dsi.fastutil.SortedPair)other).left()) && java.util.Objects.equals(Integer.valueOf(right), ((it.unimi.dsi.fastutil.SortedPair)other).right());
		}
		return false;
	}
