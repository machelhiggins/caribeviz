...
public interface IntList extends List<Integer>, Comparable<List<? extends Integer>>, IntCollection {
	...
	default IntSpliterator spliterator() {
		if (this instanceof java.util.RandomAccess) {
			...
			return IntSpliterators.asSpliterator(iterator(), sizeOf(this), IntSpliterators.LIST_SPLITERATOR_CHARACTERISTICS);
		}
	}
	 ...
	 */
	public static IntList of(final int e) {
	 ...
	 */
	public static IntList of(final int e0, final int e1) {
	 ...
	 */
	public static IntList of(final int e0, final int e1, final int e2) {
