...
public final class Int2IntSortedMaps {
	...
	public static class Singleton extends Int2IntMaps.Singleton implements Int2IntSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2IntMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Int2IntMaps.SynchronizedMap implements Int2IntSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.int2IntEntrySet(), sync);
			return (ObjectSortedSet<Int2IntMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2IntMaps.UnmodifiableMap implements Int2IntSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.int2IntEntrySet());
			return (ObjectSortedSet<Int2IntMap.Entry>)entries;
		}
