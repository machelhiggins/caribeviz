...
public class Int2DoubleLinkedOpenHashMap extends AbstractInt2DoubleSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Int2DoubleMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Int2DoubleMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractIntSortedSet {
		...
		public IntSpliterator spliterator() {
			return IntSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public DoubleCollection values() {
		if (values == null) values = new AbstractDoubleCollection() {
			...
			public DoubleSpliterator spliterator() {
				return DoubleSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2DoubleLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
