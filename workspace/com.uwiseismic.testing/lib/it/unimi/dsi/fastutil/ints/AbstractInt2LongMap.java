...
public abstract class AbstractInt2LongMap extends AbstractInt2LongFunction implements Int2LongMap, java.io.Serializable {
	 ...
	 */
	@Override
	public final long mergeLong(final int key, final long value, final it.unimi.dsi.fastutil.longs.LongBinaryOperator remappingFunction) {
	...
	public IntSet keySet() {
		return new AbstractIntSet() {
			...
			public IntSpliterator spliterator() {
				return IntSpliterators.asSpliterator(iterator(), sizeOf(AbstractInt2LongMap.this), IntSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
	...
	public LongCollection values() {
		return new AbstractLongCollection() {
			...
			public LongSpliterator spliterator() {
				return LongSpliterators.asSpliterator(iterator(), sizeOf(AbstractInt2LongMap.this), LongSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
			}
		};
	}
