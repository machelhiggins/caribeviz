	...
	*/
	...
	public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Int2IntMap.Entry>() {
			final Comparator<? super Int2IntMap.Entry> comparator = (Int2IntAVLTreeMap.this.actualComparator == null ? (Comparator<Int2IntMap.Entry>)(x, y) -> (Integer.compare((x.getIntKey()), (y.getIntKey()))) : (Comparator<Int2IntMap.Entry>)(x, y) -> Int2IntAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey()));
	...
	private final class Submap extends AbstractInt2IntSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2IntAVLTreeMap.this.compare(k, from) >= 0) && (top || Int2IntAVLTreeMap.this.compare(k, to) < 0);
		}
