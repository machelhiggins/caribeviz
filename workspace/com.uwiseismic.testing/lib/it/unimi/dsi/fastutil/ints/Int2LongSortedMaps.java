...
public final class Int2LongSortedMaps {
	...
	public static class Singleton extends Int2LongMaps.Singleton implements Int2LongSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractInt2LongMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Int2LongMaps.SynchronizedMap implements Int2LongSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.int2LongEntrySet(), sync);
			return (ObjectSortedSet<Int2LongMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2LongMaps.UnmodifiableMap implements Int2LongSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.int2LongEntrySet());
			return (ObjectSortedSet<Int2LongMap.Entry>)entries;
		}
