...
public final class Int2ObjectFunctions {
	...
	public static class UnmodifiableFunction<V> extends AbstractInt2ObjectFunction<V> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Int2ObjectFunction<? extends V> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public V getOrDefault(final int k, final V defaultValue) {
			return ((Int2ObjectFunction<V>)function).getOrDefault(k, defaultValue);
		}
	...
	public static <V> Int2ObjectFunction<V> primitive(final java.util.function.Function<? super Integer, ? extends V> f) {
		...
		if (f instanceof java.util.function.IntFunction) return ((java.util.function.IntFunction<V>)f)::apply;
