...
public class Int2LongRBTreeMap extends AbstractInt2LongSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Int2LongMap.Entry>() {
			final Comparator<? super Int2LongMap.Entry> comparator = (Int2LongRBTreeMap.this.actualComparator == null ? (Comparator<Int2LongMap.Entry>)(x, y) -> (Integer.compare((x.getIntKey()), (y.getIntKey()))) : (Comparator<Int2LongMap.Entry>)(x, y) -> Int2LongRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey()));
	...
	private final class Submap extends AbstractInt2LongSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2LongRBTreeMap.this.compare(k, from) >= 0) && (top || Int2LongRBTreeMap.this.compare(k, to) < 0);
		}
