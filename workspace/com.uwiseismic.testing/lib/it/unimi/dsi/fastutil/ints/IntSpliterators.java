...
public final class IntSpliterators {
	 ...
	 *         position {@code offset}.
	 */
	public static IntSpliterator wrapPreSorted(final int[] array, final int offset, final int length, final int additionalCharacteristics, IntComparator comparator) {
		IntArrays.ensureOffsetLength(array, offset, length);
	 ...
	 *         position {@code offset}.
	 */
	public static IntSpliterator wrapPreSorted(final int[] array, final int offset, final int length, IntComparator comparator) {
	 ...
	 *         position {@code offset}.
	 */
	public static IntSpliterator wrapPreSorted(final int[] array, IntComparator comparator) {
	...
	private static class SpliteratorWrapper implements IntSpliterator {
		...
		@Override
		public IntComparator getComparator() {
			return IntComparators.asIntComparator(i.getComparator());
		}
	...
	private static class IntervalSpliterator implements IntSpliterator {
		...
		public long skip(long n) {
			...
			if (newCurr <= to && newCurr >= curr) {
				curr = it.unimi.dsi.fastutil.SafeMath.safeLongToInt(newCurr);
				return n;
			}
			n = to - curr;
			curr = to;
	...
	private static class SpliteratorFromIterator implements IntSpliterator {
		...
		public long skip(long n) {
			if (n < 0) throw new IllegalArgumentException("Argument must be nonnegative: " + n);
			if (iter instanceof IntBigListIterator) {
				long skipped = ((IntBigListIterator)iter).skip(n);
				size -= skipped;
				return skipped;
			} else {
				long skippedSoFar = 0;
	 ...
	 */
	public static IntSpliterator wrap(final it.unimi.dsi.fastutil.bytes.ByteSpliterator spliterator) {
	 ...
	 */
	public static IntSpliterator wrap(final it.unimi.dsi.fastutil.shorts.ShortSpliterator spliterator) {
	 ...
	 */
	public static IntSpliterator wrap(final it.unimi.dsi.fastutil.chars.CharSpliterator spliterator) {
