 ...
 */
public class IntLongImmutablePair implements IntLongPair, java.io.Serializable {
	 ...
	 */
	public IntLongImmutablePair(final int left, final long right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static IntLongImmutablePair of(final int left, final long right) {
