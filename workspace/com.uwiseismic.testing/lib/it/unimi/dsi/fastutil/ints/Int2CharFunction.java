...
public interface Int2CharFunction extends Function<Integer, Character>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.ints.Int2ByteFunction andThenByte(it.unimi.dsi.fastutil.chars.Char2ByteFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2CharFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2IntFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2ShortFunction andThenShort(it.unimi.dsi.fastutil.chars.Char2ShortFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2CharFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2IntFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2IntFunction andThenInt(it.unimi.dsi.fastutil.chars.Char2IntFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2CharFunction composeInt(it.unimi.dsi.fastutil.ints.Int2IntFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2LongFunction andThenLong(it.unimi.dsi.fastutil.chars.Char2LongFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2CharFunction composeLong(it.unimi.dsi.fastutil.longs.Long2IntFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2CharFunction andThenChar(it.unimi.dsi.fastutil.chars.Char2CharFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2CharFunction composeChar(it.unimi.dsi.fastutil.chars.Char2IntFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2FloatFunction andThenFloat(it.unimi.dsi.fastutil.chars.Char2FloatFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2CharFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2IntFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.chars.Char2DoubleFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2CharFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2IntFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.ints.Int2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.chars.Char2ObjectFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2CharFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2IntFunction<? super T> before) {
		return k -> get(before.getInt(k));
	}

	default <T> it.unimi.dsi.fastutil.ints.Int2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.chars.Char2ReferenceFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2CharFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2IntFunction<? super T> before) {
		return k -> get(before.getInt(k));
	}
}
