...
public class Int2LongLinkedOpenHashMap extends AbstractInt2LongSortedMap implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Int2LongMap.Entry> implements FastSortedEntrySet {
		...
		public ObjectSpliterator<Int2LongMap.Entry> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	private final class KeySet extends AbstractIntSortedSet {
		...
		public IntSpliterator spliterator() {
			return IntSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public LongCollection values() {
		if (values == null) values = new AbstractLongCollection() {
			...
			public LongSpliterator spliterator() {
				return LongSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Int2LongLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
