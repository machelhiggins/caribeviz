	...
	*/
	...
	public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Int2ObjectMap.Entry<V>>() {
			final Comparator<? super Int2ObjectMap.Entry<V>> comparator = (Int2ObjectAVLTreeMap.this.actualComparator == null ? (Comparator<Int2ObjectMap.Entry<V>>)(x, y) -> (Integer.compare((x.getIntKey()), (y.getIntKey()))) : (Comparator<Int2ObjectMap.Entry<V>>)(x, y) -> Int2ObjectAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey()));
	...
	private final class Submap extends AbstractInt2ObjectSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2ObjectAVLTreeMap.this.compare(k, from) >= 0) && (top || Int2ObjectAVLTreeMap.this.compare(k, to) < 0);
		}
