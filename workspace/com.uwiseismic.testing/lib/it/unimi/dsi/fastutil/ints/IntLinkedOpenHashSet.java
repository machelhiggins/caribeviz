...
public class IntLinkedOpenHashSet extends AbstractIntSortedSet implements java.io.Serializable, Cloneable, Hash {
	...
	public static IntLinkedOpenHashSet toSetWithExpectedSize(java.util.stream.IntStream stream, int expectedSize) {
		...
		return stream.collect(new IntCollections.SizeDecreasingSupplier<IntLinkedOpenHashSet>(expectedSize, (int size) -> size <= Hash.DEFAULT_INITIAL_SIZE ? new IntLinkedOpenHashSet() : new IntLinkedOpenHashSet(size)), IntLinkedOpenHashSet::add, IntLinkedOpenHashSet::addAll);
	}
	...
	public IntSpliterator spliterator() {
		return IntSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(this), SPLITERATOR_CHARACTERISTICS);
	}
