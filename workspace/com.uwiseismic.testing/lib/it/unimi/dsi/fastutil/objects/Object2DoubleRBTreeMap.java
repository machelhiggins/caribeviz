...
public class Object2DoubleRBTreeMap<K> extends AbstractObject2DoubleSortedMap<K> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>() {
			final Comparator<? super Object2DoubleMap.Entry<K>> comparator = (Object2DoubleRBTreeMap.this.actualComparator == null ? (Comparator<Object2DoubleMap.Entry<K>>)(x, y) -> (((Comparable<K>)(x.getKey())).compareTo(y.getKey())) : (Comparator<Object2DoubleMap.Entry<K>>)(x, y) -> Object2DoubleRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey()));
	...
	private final class Submap extends AbstractObject2DoubleSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2DoubleRBTreeMap.this.compare(k, from) >= 0) && (top || Object2DoubleRBTreeMap.this.compare(k, to) < 0);
		}
