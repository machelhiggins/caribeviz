...
public interface Object2ObjectMap<K, V> extends Object2ObjectFunction<K, V>, Map<K, V> {
	...
	// Defaultable methods
	@Override
	default void forEach(final java.util.function.BiConsumer<? super K, ? super V> consumer) {
		final ObjectSet<Object2ObjectMap.Entry<K, V>> entrySet = object2ObjectEntrySet();
		final Consumer<Object2ObjectMap.Entry<K, V>> wrappingConsumer = (entry) -> consumer.accept((entry.getKey()), (entry.getValue()));
		if (entrySet instanceof FastEntrySet) {
			((FastEntrySet<K, V>)entrySet).fastForEach(wrappingConsumer);
		} else {
