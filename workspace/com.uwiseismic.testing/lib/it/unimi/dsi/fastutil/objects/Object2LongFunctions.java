...
public final class Object2LongFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractObject2LongFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Object2LongFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public long getOrDefault(final Object k, final long defaultValue) {
			return ((Object2LongFunction<K>)function).getOrDefault(k, defaultValue);
		}
	 ...
	 */
	public static <K> Object2LongFunction<K> unmodifiable(final Object2LongFunction<? extends K> f) {
	...
	public static <K> Object2LongFunction<K> primitive(final java.util.function.Function<? super K, ? extends Long> f) {
		...
		if (f instanceof java.util.function.ToLongFunction) return key -> ((java.util.function.ToLongFunction<K>)f).applyAsLong((K)(key));
