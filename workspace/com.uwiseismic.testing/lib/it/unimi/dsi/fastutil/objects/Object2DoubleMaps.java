...
public final class Object2DoubleMaps {
	...
	public static class Singleton<K> extends Object2DoubleFunctions.Singleton<K> implements Object2DoubleMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractObject2DoubleMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Object2DoubleFunctions.SynchronizedFunction<K> implements Object2DoubleMap<K>, java.io.Serializable {
		...
		public ObjectSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.object2DoubleEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<K> extends Object2DoubleFunctions.UnmodifiableFunction<K> implements Object2DoubleMap<K>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Object2DoubleMap<? extends K> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2DoubleEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public double getOrDefault(final Object key, final double defaultValue) {
			return ((Object2DoubleMap<K>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <K> Object2DoubleMap<K> unmodifiable(final Object2DoubleMap<? extends K> m) {
