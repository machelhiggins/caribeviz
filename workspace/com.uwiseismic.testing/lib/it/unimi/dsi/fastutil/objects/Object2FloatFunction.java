...
public interface Object2FloatFunction<K> extends Function<K, Float>, java.util.function.ToDoubleFunction<K> {
	...
	default it.unimi.dsi.fastutil.objects.Object2ByteFunction<K> andThenByte(it.unimi.dsi.fastutil.floats.Float2ByteFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2FloatFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2ObjectFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Object2ShortFunction<K> andThenShort(it.unimi.dsi.fastutil.floats.Float2ShortFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2FloatFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2ObjectFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Object2IntFunction<K> andThenInt(it.unimi.dsi.fastutil.floats.Float2IntFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2FloatFunction composeInt(it.unimi.dsi.fastutil.ints.Int2ObjectFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Object2LongFunction<K> andThenLong(it.unimi.dsi.fastutil.floats.Float2LongFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2FloatFunction composeLong(it.unimi.dsi.fastutil.longs.Long2ObjectFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Object2CharFunction<K> andThenChar(it.unimi.dsi.fastutil.floats.Float2CharFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2FloatFunction composeChar(it.unimi.dsi.fastutil.chars.Char2ObjectFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Object2FloatFunction<K> andThenFloat(it.unimi.dsi.fastutil.floats.Float2FloatFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2FloatFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2ObjectFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Object2DoubleFunction<K> andThenDouble(it.unimi.dsi.fastutil.floats.Float2DoubleFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2FloatFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2ObjectFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2ObjectFunction<K, T> andThenObject(it.unimi.dsi.fastutil.floats.Float2ObjectFunction<? extends T> after) {
		return k -> after.get(getFloat(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2FloatFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2ObjectFunction<? super T, ? extends K> before) {
		return k -> getFloat(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2ReferenceFunction<K, T> andThenReference(it.unimi.dsi.fastutil.floats.Float2ReferenceFunction<? extends T> after) {
		return k -> after.get(getFloat(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2FloatFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2ObjectFunction<? super T, ? extends K> before) {
		return k -> getFloat(before.get(k));
	}
}
