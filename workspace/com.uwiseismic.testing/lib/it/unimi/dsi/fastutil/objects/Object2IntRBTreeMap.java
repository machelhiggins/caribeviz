...
public class Object2IntRBTreeMap<K> extends AbstractObject2IntSortedMap<K> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>() {
			final Comparator<? super Object2IntMap.Entry<K>> comparator = (Object2IntRBTreeMap.this.actualComparator == null ? (Comparator<Object2IntMap.Entry<K>>)(x, y) -> (((Comparable<K>)(x.getKey())).compareTo(y.getKey())) : (Comparator<Object2IntMap.Entry<K>>)(x, y) -> Object2IntRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey()));
	...
	private final class Submap extends AbstractObject2IntSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2IntRBTreeMap.this.compare(k, from) >= 0) && (top || Object2IntRBTreeMap.this.compare(k, to) < 0);
		}
