	...
	*/
	...
	public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>() {
			final Comparator<? super Object2IntMap.Entry<K>> comparator = (Object2IntAVLTreeMap.this.actualComparator == null ? (Comparator<Object2IntMap.Entry<K>>)(x, y) -> (((Comparable<K>)(x.getKey())).compareTo(y.getKey())) : (Comparator<Object2IntMap.Entry<K>>)(x, y) -> Object2IntAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey()));
	...
	private final class Submap extends AbstractObject2IntSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2IntAVLTreeMap.this.compare(k, from) >= 0) && (top || Object2IntAVLTreeMap.this.compare(k, to) < 0);
		}
