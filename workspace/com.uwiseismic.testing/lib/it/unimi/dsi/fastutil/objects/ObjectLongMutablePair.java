 ...
 */
public class ObjectLongMutablePair<K> implements ObjectLongPair<K>, java.io.Serializable {
	 ...
	 */
	public ObjectLongMutablePair(final K left, final long right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <K> ObjectLongMutablePair<K> of(final K left, final long right) {
	...
	@Override
	public ObjectLongMutablePair<K> left(final K l) {
		left = l;
		return this;
	}
	...
	@Override
	public ObjectLongMutablePair<K> right(final long r) {
		right = r;
		return this;
	}
