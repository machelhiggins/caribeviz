...
public final class Object2ObjectSortedMaps {
	...
	public static class Singleton<K, V> extends Object2ObjectMaps.Singleton<K, V> implements Object2ObjectSortedMap<K, V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractObject2ObjectMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<K, V> extends Object2ObjectMaps.SynchronizedMap<K, V> implements Object2ObjectSortedMap<K, V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.object2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Object2ObjectMap.Entry<K, V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<K, V> extends Object2ObjectMaps.UnmodifiableMap<K, V> implements Object2ObjectSortedMap<K, V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Object2ObjectSortedMap<K, ? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.object2ObjectEntrySet());
			return (ObjectSortedSet<Object2ObjectMap.Entry<K, V>>)entries;
		}
