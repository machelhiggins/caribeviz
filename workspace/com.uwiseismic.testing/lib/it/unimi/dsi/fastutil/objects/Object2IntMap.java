...
public interface Object2IntMap<K> extends Object2IntFunction<K>, Map<K, Integer> {
	...
	// Defaultable methods
	@Override
	default void forEach(final java.util.function.BiConsumer<? super K, ? super Integer> consumer) {
		final ObjectSet<Object2IntMap.Entry<K>> entrySet = object2IntEntrySet();
		final Consumer<Object2IntMap.Entry<K>> wrappingConsumer = (entry) -> consumer.accept((entry.getKey()), Integer.valueOf(entry.getIntValue()));
	 ...
	 * @since 8.5.1
	 */
	default int mergeInt(final K key, final int value, final it.unimi.dsi.fastutil.ints.IntBinaryOperator remappingFunction) {
