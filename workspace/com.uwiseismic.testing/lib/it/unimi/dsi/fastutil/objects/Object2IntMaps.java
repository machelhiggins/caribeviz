...
public final class Object2IntMaps {
	...
	public static class Singleton<K> extends Object2IntFunctions.Singleton<K> implements Object2IntMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractObject2IntMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Object2IntFunctions.SynchronizedFunction<K> implements Object2IntMap<K>, java.io.Serializable {
		...
		public ObjectSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.object2IntEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<K> extends Object2IntFunctions.UnmodifiableFunction<K> implements Object2IntMap<K>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Object2IntMap<? extends K> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2IntEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public int getOrDefault(final Object key, final int defaultValue) {
			return ((Object2IntMap<K>)map).getOrDefault(key, defaultValue);
		}
