...
public interface Reference2FloatFunction<K> extends Function<K, Float>, java.util.function.ToDoubleFunction<K> {
	...
	default it.unimi.dsi.fastutil.objects.Reference2ByteFunction<K> andThenByte(it.unimi.dsi.fastutil.floats.Float2ByteFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2FloatFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2ShortFunction<K> andThenShort(it.unimi.dsi.fastutil.floats.Float2ShortFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2FloatFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2IntFunction<K> andThenInt(it.unimi.dsi.fastutil.floats.Float2IntFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2FloatFunction composeInt(it.unimi.dsi.fastutil.ints.Int2ReferenceFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2LongFunction<K> andThenLong(it.unimi.dsi.fastutil.floats.Float2LongFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2FloatFunction composeLong(it.unimi.dsi.fastutil.longs.Long2ReferenceFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2CharFunction<K> andThenChar(it.unimi.dsi.fastutil.floats.Float2CharFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2FloatFunction composeChar(it.unimi.dsi.fastutil.chars.Char2ReferenceFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2FloatFunction<K> andThenFloat(it.unimi.dsi.fastutil.floats.Float2FloatFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2FloatFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2ReferenceFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2DoubleFunction<K> andThenDouble(it.unimi.dsi.fastutil.floats.Float2DoubleFunction after) {
		return k -> after.get(getFloat(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2FloatFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2ReferenceFunction<K> before) {
		return k -> getFloat(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2ObjectFunction<K, T> andThenObject(it.unimi.dsi.fastutil.floats.Float2ObjectFunction<? extends T> after) {
		return k -> after.get(getFloat(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2FloatFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2ReferenceFunction<? super T, ? extends K> before) {
		return k -> getFloat(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction<K, T> andThenReference(it.unimi.dsi.fastutil.floats.Float2ReferenceFunction<? extends T> after) {
		return k -> after.get(getFloat(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2FloatFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction<? super T, ? extends K> before) {
		return k -> getFloat(before.get(k));
	}
}
