...
public interface Object2DoubleFunction<K> extends Function<K, Double>, java.util.function.ToDoubleFunction<K> {
	...
	default it.unimi.dsi.fastutil.objects.Object2ByteFunction<K> andThenByte(it.unimi.dsi.fastutil.doubles.Double2ByteFunction after) {
		return k -> after.get(getDouble(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2ObjectFunction<K> before) {
		return k -> getDouble(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Object2ShortFunction<K> andThenShort(it.unimi.dsi.fastutil.doubles.Double2ShortFunction after) {
		return k -> after.get(getDouble(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2DoubleFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2ObjectFunction<K> before) {
		return k -> getDouble(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Object2IntFunction<K> andThenInt(it.unimi.dsi.fastutil.doubles.Double2IntFunction after) {
		return k -> after.get(getDouble(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2DoubleFunction composeInt(it.unimi.dsi.fastutil.ints.Int2ObjectFunction<K> before) {
		return k -> getDouble(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Object2LongFunction<K> andThenLong(it.unimi.dsi.fastutil.doubles.Double2LongFunction after) {
		return k -> after.get(getDouble(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2DoubleFunction composeLong(it.unimi.dsi.fastutil.longs.Long2ObjectFunction<K> before) {
		return k -> getDouble(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Object2CharFunction<K> andThenChar(it.unimi.dsi.fastutil.doubles.Double2CharFunction after) {
		return k -> after.get(getDouble(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2DoubleFunction composeChar(it.unimi.dsi.fastutil.chars.Char2ObjectFunction<K> before) {
		return k -> getDouble(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Object2FloatFunction<K> andThenFloat(it.unimi.dsi.fastutil.doubles.Double2FloatFunction after) {
		return k -> after.get(getDouble(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2DoubleFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2ObjectFunction<K> before) {
		return k -> getDouble(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Object2DoubleFunction<K> andThenDouble(it.unimi.dsi.fastutil.doubles.Double2DoubleFunction after) {
		return k -> after.get(getDouble(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2DoubleFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2ObjectFunction<K> before) {
		return k -> getDouble(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2ObjectFunction<K, T> andThenObject(it.unimi.dsi.fastutil.doubles.Double2ObjectFunction<? extends T> after) {
		return k -> after.get(getDouble(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2DoubleFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2ObjectFunction<? super T, ? extends K> before) {
		return k -> getDouble(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2ReferenceFunction<K, T> andThenReference(it.unimi.dsi.fastutil.doubles.Double2ReferenceFunction<? extends T> after) {
		return k -> after.get(getDouble(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2DoubleFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2ObjectFunction<? super T, ? extends K> before) {
		return k -> getDouble(before.get(k));
	}
}
