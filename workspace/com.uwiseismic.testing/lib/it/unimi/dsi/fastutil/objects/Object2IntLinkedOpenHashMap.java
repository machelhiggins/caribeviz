...
public class Object2IntLinkedOpenHashMap<K> extends AbstractObject2IntSortedMap<K> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2IntMap.Entry<K>> implements FastSortedEntrySet<K> {
		...
		public ObjectSpliterator<Object2IntMap.Entry<K>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Object2IntLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public IntCollection values() {
		if (values == null) values = new AbstractIntCollection() {
			...
			public IntSpliterator spliterator() {
				return IntSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Object2IntLinkedOpenHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
