...
public interface Reference2CharFunction<K> extends Function<K, Character>, java.util.function.ToIntFunction<K> {
	...
	default it.unimi.dsi.fastutil.objects.Reference2ByteFunction<K> andThenByte(it.unimi.dsi.fastutil.chars.Char2ByteFunction after) {
		return k -> after.get(getChar(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2CharFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunction<K> before) {
		return k -> getChar(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2ShortFunction<K> andThenShort(it.unimi.dsi.fastutil.chars.Char2ShortFunction after) {
		return k -> after.get(getChar(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2CharFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction<K> before) {
		return k -> getChar(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2IntFunction<K> andThenInt(it.unimi.dsi.fastutil.chars.Char2IntFunction after) {
		return k -> after.get(getChar(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2CharFunction composeInt(it.unimi.dsi.fastutil.ints.Int2ReferenceFunction<K> before) {
		return k -> getChar(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2LongFunction<K> andThenLong(it.unimi.dsi.fastutil.chars.Char2LongFunction after) {
		return k -> after.get(getChar(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2CharFunction composeLong(it.unimi.dsi.fastutil.longs.Long2ReferenceFunction<K> before) {
		return k -> getChar(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2CharFunction<K> andThenChar(it.unimi.dsi.fastutil.chars.Char2CharFunction after) {
		return k -> after.get(getChar(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2CharFunction composeChar(it.unimi.dsi.fastutil.chars.Char2ReferenceFunction<K> before) {
		return k -> getChar(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2FloatFunction<K> andThenFloat(it.unimi.dsi.fastutil.chars.Char2FloatFunction after) {
		return k -> after.get(getChar(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2CharFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2ReferenceFunction<K> before) {
		return k -> getChar(before.get(k));
	}

	default it.unimi.dsi.fastutil.objects.Reference2DoubleFunction<K> andThenDouble(it.unimi.dsi.fastutil.chars.Char2DoubleFunction after) {
		return k -> after.get(getChar(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2CharFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2ReferenceFunction<K> before) {
		return k -> getChar(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2ObjectFunction<K, T> andThenObject(it.unimi.dsi.fastutil.chars.Char2ObjectFunction<? extends T> after) {
		return k -> after.get(getChar(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2CharFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2ReferenceFunction<? super T, ? extends K> before) {
		return k -> getChar(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction<K, T> andThenReference(it.unimi.dsi.fastutil.chars.Char2ReferenceFunction<? extends T> after) {
		return k -> after.get(getChar(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2CharFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction<? super T, ? extends K> before) {
		return k -> getChar(before.get(k));
	}
}
