	...
	*/
	...
	public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>() {
			final Comparator<? super Object2LongMap.Entry<K>> comparator = (Object2LongAVLTreeMap.this.actualComparator == null ? (Comparator<Object2LongMap.Entry<K>>)(x, y) -> (((Comparable<K>)(x.getKey())).compareTo(y.getKey())) : (Comparator<Object2LongMap.Entry<K>>)(x, y) -> Object2LongAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey()));
	...
	private final class Submap extends AbstractObject2LongSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2LongAVLTreeMap.this.compare(k, from) >= 0) && (top || Object2LongAVLTreeMap.this.compare(k, to) < 0);
		}
