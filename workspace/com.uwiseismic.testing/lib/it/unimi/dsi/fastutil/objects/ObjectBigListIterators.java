...
public final class ObjectBigListIterators {
	...
	public static class UnmodifiableBigListIterator<K> implements ObjectBigListIterator<K> {
		...
		public UnmodifiableBigListIterator(final ObjectBigListIterator<? extends K> i) {
			this.i = i;
		}
	 ...
	 */
	public static <K> ObjectBigListIterator<K> unmodifiable(final ObjectBigListIterator<? extends K> i) {
	...
	public static abstract class AbstractIndexBasedBigListIterator<K> extends AbstractIndexBasedBigIterator<K> implements ObjectBigListIterator<K> {
		 ...
		 */
		protected abstract void add(long location, K k);
		 ...
		 * See {@link #pos} and {@link #get(int)} for discussion on what the location means.
		 */
		protected abstract void set(long location, K k);
