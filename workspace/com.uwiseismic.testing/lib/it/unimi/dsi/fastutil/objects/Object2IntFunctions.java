...
public final class Object2IntFunctions {
	...
	public static class UnmodifiableFunction<K> extends AbstractObject2IntFunction<K> implements java.io.Serializable {
		...
		protected UnmodifiableFunction(final Object2IntFunction<? extends K> f) {
			if (f == null) throw new NullPointerException();
			this.function = f;
		}
		...
		public int getOrDefault(final Object k, final int defaultValue) {
			return ((Object2IntFunction<K>)function).getOrDefault(k, defaultValue);
		}
	...
	public static <K> Object2IntFunction<K> primitive(final java.util.function.Function<? super K, ? extends Integer> f) {
		...
		if (f instanceof java.util.function.ToIntFunction) return key -> ((java.util.function.ToIntFunction<K>)f).applyAsInt((K)(key));
