...
public final class Object2LongMaps {
	...
	public static class EmptyMap<K> extends Object2LongFunctions.EmptyFunction<K> implements Object2LongMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super K, ? super Long> consumer) {
		}
	...
	public static class Singleton<K> extends Object2LongFunctions.Singleton<K> implements Object2LongMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractObject2LongMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Object2LongFunctions.SynchronizedFunction<K> implements Object2LongMap<K>, java.io.Serializable {
		...
		public ObjectSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.object2LongEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public long computeIfAbsent(final K key, final java.util.function.ToLongFunction<? super K> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public long merge(final K key, final long value, final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Long computeIfPresent(final K key, final java.util.function.BiFunction<? super K, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Long compute(final K key, final java.util.function.BiFunction<? super K, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Object2LongFunctions.UnmodifiableFunction<K> implements Object2LongMap<K>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Object2LongMap<? extends K> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2LongEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public long getOrDefault(final Object key, final long defaultValue) {
			return ((Object2LongMap<K>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <K> Object2LongMap<K> unmodifiable(final Object2LongMap<? extends K> m) {
