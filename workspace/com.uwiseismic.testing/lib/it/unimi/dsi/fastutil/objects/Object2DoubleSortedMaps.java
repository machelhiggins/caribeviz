...
public final class Object2DoubleSortedMaps {
	...
	public static class Singleton<K> extends Object2DoubleMaps.Singleton<K> implements Object2DoubleSortedMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractObject2DoubleMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<K> extends Object2DoubleMaps.SynchronizedMap<K> implements Object2DoubleSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.object2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Object2DoubleMap.Entry<K>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Object2DoubleMaps.UnmodifiableMap<K> implements Object2DoubleSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.object2DoubleEntrySet());
			return (ObjectSortedSet<Object2DoubleMap.Entry<K>>)entries;
		}
