...
public class ObjectLinkedOpenHashSet<K> extends AbstractObjectSortedSet<K> implements java.io.Serializable, Cloneable, Hash {
	...
	public static <K> ObjectLinkedOpenHashSet<K> of(final K e) {
		ObjectLinkedOpenHashSet<K> result = new ObjectLinkedOpenHashSet<>(1, DEFAULT_LOAD_FACTOR);
		result.add(e);
		return result;
	}
	...
	public static <K> ObjectLinkedOpenHashSet<K> of(final K e0, final K e1) {
		ObjectLinkedOpenHashSet<K> result = new ObjectLinkedOpenHashSet<>(2, DEFAULT_LOAD_FACTOR);
		result.add(e0);
		if (!result.add(e1)) {
	...
	public static <K> ObjectLinkedOpenHashSet<K> of(final K e0, final K e1, final K e2) {
		ObjectLinkedOpenHashSet<K> result = new ObjectLinkedOpenHashSet<>(3, DEFAULT_LOAD_FACTOR);
		result.add(e0);
		if (!result.add(e1)) {
			throw new IllegalArgumentException("Duplicate element: " + e1);
		}
	...
	public static <K> ObjectLinkedOpenHashSet<K> of(final K... a) {
		ObjectLinkedOpenHashSet<K> result = new ObjectLinkedOpenHashSet<>(a.length, DEFAULT_LOAD_FACTOR);
		for (K element : a) {
	...
	public static <K> Collector<K, ?, ObjectLinkedOpenHashSet<K>> toSetWithExpectedSize(int expectedSize) {
		...
		return Collector.of(new ObjectCollections.SizeDecreasingSupplier<K, ObjectLinkedOpenHashSet<K>>(expectedSize, (int size) -> size <= Hash.DEFAULT_INITIAL_SIZE ? new ObjectLinkedOpenHashSet<K>() : new ObjectLinkedOpenHashSet<K>(size)), ObjectLinkedOpenHashSet::add, ObjectLinkedOpenHashSet::combine);
	}
