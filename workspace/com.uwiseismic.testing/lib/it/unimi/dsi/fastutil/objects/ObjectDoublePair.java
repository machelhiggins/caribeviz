 ...
 */
public interface ObjectDoublePair<K> extends it.unimi.dsi.fastutil.Pair<K, Double> {
	/**
	 ...
	 */
	public default ObjectDoublePair<K> right(final double r) {
	...
	@Deprecated
	@Override
	public default ObjectDoublePair<K> right(final Double l) {
	 ...
	 */
	public default ObjectDoublePair<K> second(final double r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ObjectDoublePair<K> second(final Double l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default ObjectDoublePair<K> value(final double r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default ObjectDoublePair<K> value(final Double l) {
	 ...
	 */
	public static <K> ObjectDoublePair<K> of(final K left, final double right) {
	...
	public static <K> java.util.Comparator<ObjectDoublePair<K>> lexComparator() {
		return (x, y) -> {
