...
public final class Object2LongSortedMaps {
	...
	public static class Singleton<K> extends Object2LongMaps.Singleton<K> implements Object2LongSortedMap<K>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractObject2LongMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<K> extends Object2LongMaps.SynchronizedMap<K> implements Object2LongSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.object2LongEntrySet(), sync);
			return (ObjectSortedSet<Object2LongMap.Entry<K>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Object2LongMaps.UnmodifiableMap<K> implements Object2LongSortedMap<K>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.object2LongEntrySet());
			return (ObjectSortedSet<Object2LongMap.Entry<K>>)entries;
		}
