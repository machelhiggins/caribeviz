 ...
 */
public class ObjectDoubleImmutablePair<K> implements ObjectDoublePair<K>, java.io.Serializable {
	 ...
	 */
	public ObjectDoubleImmutablePair(final K left, final double right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static <K> ObjectDoubleImmutablePair<K> of(final K left, final double right) {
