...
public class Object2LongLinkedOpenCustomHashMap<K> extends AbstractObject2LongSortedMap<K> implements java.io.Serializable, Cloneable, Hash {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2LongMap.Entry<K>> implements FastSortedEntrySet<K> {
		...
		public ObjectSpliterator<Object2LongMap.Entry<K>> spliterator() {
			return ObjectSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Object2LongLinkedOpenCustomHashMap.this), SPLITERATOR_CHARACTERISTICS);
		}
	...
	public LongCollection values() {
		if (values == null) values = new AbstractLongCollection() {
			...
			public LongSpliterator spliterator() {
				return LongSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(Object2LongLinkedOpenCustomHashMap.this), SPLITERATOR_CHARACTERISTICS);
			}
