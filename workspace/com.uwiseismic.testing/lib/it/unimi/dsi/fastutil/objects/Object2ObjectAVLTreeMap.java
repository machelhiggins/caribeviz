	...
	*/
	...
	public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>() {
			final Comparator<? super Object2ObjectMap.Entry<K, V>> comparator = (Object2ObjectAVLTreeMap.this.actualComparator == null ? (Comparator<Object2ObjectMap.Entry<K, V>>)(x, y) -> (((Comparable<K>)(x.getKey())).compareTo(y.getKey())) : (Comparator<Object2ObjectMap.Entry<K, V>>)(x, y) -> Object2ObjectAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey()));
	...
	private final class Submap extends AbstractObject2ObjectSortedMap<K, V> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2ObjectAVLTreeMap.this.compare(k, from) >= 0) && (top || Object2ObjectAVLTreeMap.this.compare(k, to) < 0);
		}
