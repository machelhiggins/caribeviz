...
public final class FloatLists {
	...
	public static class EmptyList extends FloatCollections.EmptyCollection implements FloatList, RandomAccess, java.io.Serializable, Cloneable {
		...
		@Deprecated
		@Override
		public void replaceAll(final java.util.function.UnaryOperator<Float> operator) {
			throw new UnsupportedOperationException();
		}
		...
		public FloatListIterator listIterator(int i) {
			if (i == 0) return FloatIterators.EMPTY_ITERATOR;
	...
	public static class UnmodifiableList extends FloatCollections.UnmodifiableCollection implements FloatList, java.io.Serializable {
		...
		@Override
		public void replaceAll(final java.util.function.DoubleUnaryOperator operator) {
			throw new UnsupportedOperationException();
		}
	...
	static abstract class ImmutableListBase extends AbstractFloatList implements FloatList {
		/**
		...
		@Override
		@Deprecated
		public final void add(final int index, final float k) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final boolean add(final float k) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final boolean addAll(final java.util.Collection<? extends Float> c) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final boolean addAll(int index, final java.util.Collection<? extends Float> c) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final float removeFloat(final int index) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final boolean rem(final float k) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final boolean removeIf(final java.util.function.Predicate<? super Float> c) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final boolean removeIf(final FloatPredicate c) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final void replaceAll(final java.util.function.UnaryOperator<Float> operator) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final Float set(final int index, final Float k) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final boolean addAll(final FloatList c) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final boolean addAll(final int index, final FloatCollection c) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final boolean addAll(final int index, final FloatList c) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final void addElements(final int index, final float a[], final int offset, final int length) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final void setElements(final int index, final float a[], final int offset, final int length) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final void sort(final FloatComparator comp) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final void unstableSort(final FloatComparator comp) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final void sort(final java.util.Comparator<? super Float> comparator) {
			throw new UnsupportedOperationException();
		}
		...
		@Override
		@Deprecated
		public final void unstableSort(final java.util.Comparator<? super Float> comparator) {
			throw new UnsupportedOperationException();
		}
	}
}
