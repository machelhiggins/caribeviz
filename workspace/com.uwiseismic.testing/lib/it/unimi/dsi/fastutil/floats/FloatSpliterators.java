...
public final class FloatSpliterators {
	 ...
	 *         position {@code offset}.
	 */
	public static FloatSpliterator wrapPreSorted(final float[] array, final int offset, final int length, final int additionalCharacteristics, FloatComparator comparator) {
		FloatArrays.ensureOffsetLength(array, offset, length);
	 ...
	 *         position {@code offset}.
	 */
	public static FloatSpliterator wrapPreSorted(final float[] array, final int offset, final int length, FloatComparator comparator) {
	 ...
	 *         position {@code offset}.
	 */
	public static FloatSpliterator wrapPreSorted(final float[] array, FloatComparator comparator) {
	...
	private static class SpliteratorWrapper implements FloatSpliterator {
		...
		@Override
		public FloatComparator getComparator() {
			return FloatComparators.asFloatComparator(i.getComparator());
		}
	...
	private static class PrimitiveSpliteratorWrapper implements FloatSpliterator {
		...
		public FloatComparator getComparator() {
			...
			final java.util.Comparator<? super Double> comp = i.getComparator();
			return (float left, float right) -> comp.compare(Double.valueOf(left), Double.valueOf(right));
		}
	...
	private static class PrimitiveSpliteratorWrapperWithComparator extends PrimitiveSpliteratorWrapper {
		...
		public PrimitiveSpliteratorWrapperWithComparator(final Spliterator.OfDouble i, final FloatComparator comparator) {
			super(i);
			this.comparator = comparator;
		}
	 ...
	 * @return a type-specific spliterator backed by {@code i}
	 */
	public static FloatSpliterator narrow(final Spliterator.OfDouble i) {
	 ...
	 * potential for parallelism).
	 */
	public static void onEachMatching(final FloatSpliterator spliterator, final java.util.function.DoublePredicate predicate, final java.util.function.DoubleConsumer action) {
		Objects.requireNonNull(predicate);
		Objects.requireNonNull(action);
	...
	private static class SpliteratorFromIterator implements FloatSpliterator {
		...
		public long skip(long n) {
			if (n < 0) throw new IllegalArgumentException("Argument must be nonnegative: " + n);
			if (iter instanceof FloatBigListIterator) {
				long skipped = ((FloatBigListIterator)iter).skip(n);
				size -= skipped;
				return skipped;
			} else {
				long skippedSoFar = 0;
	 ...
	 *         return.
	 */
	public static FloatSpliterator asSpliteratorFromSorted(final FloatIterator iter, final long size, final int additionalCharacterisitcs, final FloatComparator comparator) {
	 ...
	 */
	public static FloatSpliterator wrap(final it.unimi.dsi.fastutil.bytes.ByteSpliterator spliterator) {
	 ...
	 */
	public static FloatSpliterator wrap(final it.unimi.dsi.fastutil.shorts.ShortSpliterator spliterator) {
	 ...
	 */
	public static FloatSpliterator wrap(final it.unimi.dsi.fastutil.chars.CharSpliterator spliterator) {
