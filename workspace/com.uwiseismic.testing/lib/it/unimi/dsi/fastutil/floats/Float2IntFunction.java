...
public interface Float2IntFunction extends Function<Float, Integer>, java.util.function.DoubleToIntFunction {
	...
	default it.unimi.dsi.fastutil.floats.Float2ByteFunction andThenByte(it.unimi.dsi.fastutil.ints.Int2ByteFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2IntFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2FloatFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2ShortFunction andThenShort(it.unimi.dsi.fastutil.ints.Int2ShortFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2IntFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2FloatFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2IntFunction andThenInt(it.unimi.dsi.fastutil.ints.Int2IntFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2IntFunction composeInt(it.unimi.dsi.fastutil.ints.Int2FloatFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2LongFunction andThenLong(it.unimi.dsi.fastutil.ints.Int2LongFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2IntFunction composeLong(it.unimi.dsi.fastutil.longs.Long2FloatFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2CharFunction andThenChar(it.unimi.dsi.fastutil.ints.Int2CharFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2IntFunction composeChar(it.unimi.dsi.fastutil.chars.Char2FloatFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2FloatFunction andThenFloat(it.unimi.dsi.fastutil.ints.Int2FloatFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2IntFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2FloatFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.ints.Int2DoubleFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2IntFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2FloatFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.floats.Float2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.ints.Int2ObjectFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2IntFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2FloatFunction<? super T> before) {
		return k -> get(before.getFloat(k));
	}

	default <T> it.unimi.dsi.fastutil.floats.Float2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.ints.Int2ReferenceFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2IntFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2FloatFunction<? super T> before) {
		return k -> get(before.getFloat(k));
	}
}
