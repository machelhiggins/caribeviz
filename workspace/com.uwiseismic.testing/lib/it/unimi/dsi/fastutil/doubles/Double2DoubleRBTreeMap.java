...
public class Double2DoubleRBTreeMap extends AbstractDouble2DoubleSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2DoubleMap.Entry>() {
			final Comparator<? super Double2DoubleMap.Entry> comparator = (Double2DoubleRBTreeMap.this.actualComparator == null ? (Comparator<Double2DoubleMap.Entry>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2DoubleMap.Entry>)(x, y) -> Double2DoubleRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
	...
	private final class Submap extends AbstractDouble2DoubleSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2DoubleRBTreeMap.this.compare(k, from) >= 0) && (top || Double2DoubleRBTreeMap.this.compare(k, to) < 0);
		}
