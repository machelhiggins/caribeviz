 ...
 */
public interface DoubleIntPair extends it.unimi.dsi.fastutil.Pair<Double, Integer> {
	/**
	 ...
	 */
	public default DoubleIntPair left(final double l) {
	 ...
	 */
	public default DoubleIntPair first(final double l) {
		return left(l);
	}
	 ...
	 * @implSpec This implementation delegates to {@link #left(Object)}.
	 */
	public default DoubleIntPair key(final double l) {
		return left(l);
	}

	@Override
	@Deprecated
	public default DoubleIntPair key(Double l) {
	 ...
	 * @implSpec This implementation throws an {@link UnsupportedOperationException}.
	 */
	public default DoubleIntPair right(final int r) {
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	public default DoubleIntPair right(final Integer l) {
	 ...
	 */
	public default DoubleIntPair second(final int r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default DoubleIntPair second(final Integer l) {
	 ...
	 * @implSpec This implementation delegates to {@link #right(Object)}.
	 */
	public default DoubleIntPair value(final int r) {
		return right(r);
	}
	...
	@Deprecated
	@Override
	public default DoubleIntPair value(final Integer l) {
	 ...
	 */
	public static DoubleIntPair of(final double left, final int right) {
	...
	public static java.util.Comparator<DoubleIntPair> lexComparator() {
		return (x, y) -> {
