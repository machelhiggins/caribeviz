 ...
 */
public class DoubleLongMutablePair implements DoubleLongPair, java.io.Serializable {
	 ...
	 */
	public DoubleLongMutablePair(final double left, final long right) {
		this.left = left;
		this.right = right;
	}
	 ...
	 */
	public static DoubleLongMutablePair of(final double left, final long right) {
	...
	@Override
	public DoubleLongMutablePair left(final double l) {
		left = l;
		return this;
	}
	...
	@Override
	public DoubleLongMutablePair right(final long r) {
		right = r;
		return this;
	}
