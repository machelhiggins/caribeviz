...
public class DoubleLinkedOpenHashSet extends AbstractDoubleSortedSet implements java.io.Serializable, Cloneable, Hash {
	...
	public static DoubleLinkedOpenHashSet toSetWithExpectedSize(java.util.stream.DoubleStream stream, int expectedSize) {
		...
		return stream.collect(new DoubleCollections.SizeDecreasingSupplier<DoubleLinkedOpenHashSet>(expectedSize, (int size) -> size <= Hash.DEFAULT_INITIAL_SIZE ? new DoubleLinkedOpenHashSet() : new DoubleLinkedOpenHashSet(size)), DoubleLinkedOpenHashSet::add, DoubleLinkedOpenHashSet::addAll);
	}
	...
	public DoubleSpliterator spliterator() {
		return DoubleSpliterators.asSpliterator(iterator(), it.unimi.dsi.fastutil.Size64.sizeOf(this), SPLITERATOR_CHARACTERISTICS);
	}
