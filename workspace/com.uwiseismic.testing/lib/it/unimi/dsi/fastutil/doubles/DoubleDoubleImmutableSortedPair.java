...
public class DoubleDoubleImmutableSortedPair extends DoubleDoubleImmutablePair implements DoubleDoubleSortedPair, java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if (other instanceof DoubleDoubleSortedPair) {
			return left == ((DoubleDoubleSortedPair)other).leftDouble() && right == ((DoubleDoubleSortedPair)other).rightDouble();
		}
		if (other instanceof it.unimi.dsi.fastutil.SortedPair) {
			return java.util.Objects.equals(Double.valueOf(left), ((it.unimi.dsi.fastutil.SortedPair)other).left()) && java.util.Objects.equals(Double.valueOf(right), ((it.unimi.dsi.fastutil.SortedPair)other).right());
		}
		return false;
	}
