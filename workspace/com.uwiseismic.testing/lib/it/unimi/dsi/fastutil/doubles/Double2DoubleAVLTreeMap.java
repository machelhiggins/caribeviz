	...
	*/
	...
	public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2DoubleMap.Entry>() {
			final Comparator<? super Double2DoubleMap.Entry> comparator = (Double2DoubleAVLTreeMap.this.actualComparator == null ? (Comparator<Double2DoubleMap.Entry>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2DoubleMap.Entry>)(x, y) -> Double2DoubleAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
			...
			public boolean remove(final Object o) {
				...
				if (!(e.getValue() instanceof Double)) return false;
				final Entry f = findKey(((Double)(e.getKey())).doubleValue());
	...
	private final class Submap extends AbstractDouble2DoubleSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2DoubleAVLTreeMap.this.compare(k, from) >= 0) && (top || Double2DoubleAVLTreeMap.this.compare(k, to) < 0);
		}
