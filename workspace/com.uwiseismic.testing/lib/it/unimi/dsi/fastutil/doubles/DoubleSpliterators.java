...
public final class DoubleSpliterators {
	 ...
	 *         position {@code offset}.
	 */
	public static DoubleSpliterator wrapPreSorted(final double[] array, final int offset, final int length, final int additionalCharacteristics, DoubleComparator comparator) {
		DoubleArrays.ensureOffsetLength(array, offset, length);
	 ...
	 *         position {@code offset}.
	 */
	public static DoubleSpliterator wrapPreSorted(final double[] array, final int offset, final int length, DoubleComparator comparator) {
	 ...
	 *         position {@code offset}.
	 */
	public static DoubleSpliterator wrapPreSorted(final double[] array, DoubleComparator comparator) {
	...
	private static class SpliteratorWrapper implements DoubleSpliterator {
		...
		@Override
		public DoubleComparator getComparator() {
			return DoubleComparators.asDoubleComparator(i.getComparator());
		}
	...
	private static class SpliteratorFromIterator implements DoubleSpliterator {
		...
		public long skip(long n) {
			if (n < 0) throw new IllegalArgumentException("Argument must be nonnegative: " + n);
			if (iter instanceof DoubleBigListIterator) {
				long skipped = ((DoubleBigListIterator)iter).skip(n);
				size -= skipped;
				return skipped;
			} else {
				long skippedSoFar = 0;
	 ...
	 *         return.
	 */
	public static DoubleSpliterator asSpliteratorFromSorted(final DoubleIterator iter, final long size, final int additionalCharacterisitcs, final DoubleComparator comparator) {
	 ...
	 */
	public static DoubleSpliterator wrap(final it.unimi.dsi.fastutil.bytes.ByteSpliterator spliterator) {
	 ...
	 */
	public static DoubleSpliterator wrap(final it.unimi.dsi.fastutil.shorts.ShortSpliterator spliterator) {
	 ...
	 */
	public static DoubleSpliterator wrap(final it.unimi.dsi.fastutil.chars.CharSpliterator spliterator) {
	 ...
	 */
	public static DoubleSpliterator wrap(final it.unimi.dsi.fastutil.ints.IntSpliterator spliterator) {
	 ...
	 */
	public static DoubleSpliterator wrap(final it.unimi.dsi.fastutil.floats.FloatSpliterator spliterator) {
