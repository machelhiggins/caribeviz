...
public class Double2LongRBTreeMap extends AbstractDouble2LongSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2LongMap.Entry>() {
			final Comparator<? super Double2LongMap.Entry> comparator = (Double2LongRBTreeMap.this.actualComparator == null ? (Comparator<Double2LongMap.Entry>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2LongMap.Entry>)(x, y) -> Double2LongRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
	...
	private final class Submap extends AbstractDouble2LongSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2LongRBTreeMap.this.compare(k, from) >= 0) && (top || Double2LongRBTreeMap.this.compare(k, to) < 0);
		}
