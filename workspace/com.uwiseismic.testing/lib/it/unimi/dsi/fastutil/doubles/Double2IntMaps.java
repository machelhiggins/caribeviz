...
public final class Double2IntMaps {
	...
	public static class EmptyMap extends Double2IntFunctions.EmptyFunction implements Double2IntMap, java.io.Serializable, Cloneable {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Double, ? super Integer> consumer) {
		}
	...
	public static class Singleton extends Double2IntFunctions.Singleton implements Double2IntMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Double2IntMap.Entry> double2IntEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractDouble2IntMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Double2IntFunctions.SynchronizedFunction implements Double2IntMap, java.io.Serializable {
		...
		public ObjectSet<Double2IntMap.Entry> double2IntEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.double2IntEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Double, ? super Integer, ? extends Integer> function) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsentNullable(final double key, final java.util.function.DoubleFunction<? extends Integer> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsent(final double key, final Double2IntFunction mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Integer computeIfPresent(final Double key, final java.util.function.BiFunction<? super Double, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Integer compute(final Double key, final java.util.function.BiFunction<? super Double, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Integer merge(final Double key, final Integer value, final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Double2IntFunctions.UnmodifiableFunction implements Double2IntMap, java.io.Serializable {
		...
		@Override
		public ObjectSet<Double2IntMap.Entry> double2IntEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.double2IntEntrySet());
			return entries;
		}
