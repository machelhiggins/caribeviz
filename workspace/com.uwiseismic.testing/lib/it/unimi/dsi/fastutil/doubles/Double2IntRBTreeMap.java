...
public class Double2IntRBTreeMap extends AbstractDouble2IntSortedMap implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2IntMap.Entry>() {
			final Comparator<? super Double2IntMap.Entry> comparator = (Double2IntRBTreeMap.this.actualComparator == null ? (Comparator<Double2IntMap.Entry>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2IntMap.Entry>)(x, y) -> Double2IntRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
	...
	private final class Submap extends AbstractDouble2IntSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2IntRBTreeMap.this.compare(k, from) >= 0) && (top || Double2IntRBTreeMap.this.compare(k, to) < 0);
		}
