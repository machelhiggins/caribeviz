...
public interface Double2FloatFunction extends Function<Double, Float>, java.util.function.DoubleUnaryOperator {
	...
	default it.unimi.dsi.fastutil.doubles.Double2ByteFunction andThenByte(it.unimi.dsi.fastutil.floats.Float2ByteFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2FloatFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2ShortFunction andThenShort(it.unimi.dsi.fastutil.floats.Float2ShortFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2FloatFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2IntFunction andThenInt(it.unimi.dsi.fastutil.floats.Float2IntFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2FloatFunction composeInt(it.unimi.dsi.fastutil.ints.Int2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2LongFunction andThenLong(it.unimi.dsi.fastutil.floats.Float2LongFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2FloatFunction composeLong(it.unimi.dsi.fastutil.longs.Long2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2CharFunction andThenChar(it.unimi.dsi.fastutil.floats.Float2CharFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2FloatFunction composeChar(it.unimi.dsi.fastutil.chars.Char2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2FloatFunction andThenFloat(it.unimi.dsi.fastutil.floats.Float2FloatFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2FloatFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.floats.Float2DoubleFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2FloatFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.doubles.Double2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.floats.Float2ObjectFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2FloatFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2DoubleFunction<? super T> before) {
		return k -> get(before.getDouble(k));
	}

	default <T> it.unimi.dsi.fastutil.doubles.Double2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.floats.Float2ReferenceFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2FloatFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2DoubleFunction<? super T> before) {
		return k -> get(before.getDouble(k));
	}
}
