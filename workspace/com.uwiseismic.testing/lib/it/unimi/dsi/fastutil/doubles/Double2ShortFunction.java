...
public interface Double2ShortFunction extends Function<Double, Short>, java.util.function.DoubleToIntFunction {
	...
	default Short get(final Object key) {
		...
		final short v;
		return ((v = get(k)) != defaultReturnValue() || containsKey(k)) ? Short.valueOf(v) : null;
	}
	...
	default it.unimi.dsi.fastutil.doubles.Double2ByteFunction andThenByte(it.unimi.dsi.fastutil.shorts.Short2ByteFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2ShortFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2ShortFunction andThenShort(it.unimi.dsi.fastutil.shorts.Short2ShortFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2ShortFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2IntFunction andThenInt(it.unimi.dsi.fastutil.shorts.Short2IntFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2ShortFunction composeInt(it.unimi.dsi.fastutil.ints.Int2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2LongFunction andThenLong(it.unimi.dsi.fastutil.shorts.Short2LongFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2ShortFunction composeLong(it.unimi.dsi.fastutil.longs.Long2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2CharFunction andThenChar(it.unimi.dsi.fastutil.shorts.Short2CharFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2ShortFunction composeChar(it.unimi.dsi.fastutil.chars.Char2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2FloatFunction andThenFloat(it.unimi.dsi.fastutil.shorts.Short2FloatFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2ShortFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.shorts.Short2DoubleFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2ShortFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.doubles.Double2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.shorts.Short2ObjectFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2ShortFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2DoubleFunction<? super T> before) {
		return k -> get(before.getDouble(k));
	}

	default <T> it.unimi.dsi.fastutil.doubles.Double2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2ShortFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2DoubleFunction<? super T> before) {
		return k -> get(before.getDouble(k));
	}
}
