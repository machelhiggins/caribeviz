...
public interface DoubleList extends List<Double>, Comparable<List<? extends Double>>, DoubleCollection {
	...
	default DoubleSpliterator spliterator() {
		if (this instanceof java.util.RandomAccess) {
			...
			return DoubleSpliterators.asSpliterator(iterator(), sizeOf(this), DoubleSpliterators.LIST_SPLITERATOR_CHARACTERISTICS);
		}
	}
	 ...
	 */
	default void replaceAll(final java.util.function.DoubleUnaryOperator operator) {
	...
	default void replaceAll(final java.util.function.UnaryOperator<Double> operator) {
		...
		replaceAll(operator instanceof java.util.function.DoubleUnaryOperator ? (java.util.function.DoubleUnaryOperator)operator : (java.util.function.DoubleUnaryOperator)operator::apply);
	}
	 ...
	 */
	public static DoubleList of(final double e) {
	 ...
	 */
	public static DoubleList of(final double e0, final double e1) {
	 ...
	 */
	public static DoubleList of(final double e0, final double e1, final double e2) {
