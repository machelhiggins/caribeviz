...
public interface DoubleDoubleSortedPair extends DoubleDoublePair, it.unimi.dsi.fastutil.SortedPair<Double>, java.io.Serializable {
	/**
	 ...
	 *           implementation.
	 */
	public static DoubleDoubleSortedPair of(final double left, final double right) {
	 ...
	 */
	default boolean contains(final double e) {
