...
public final class Double2ObjectMaps {
	...
	public static class Singleton<V> extends Double2ObjectFunctions.Singleton<V> implements Double2ObjectMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.singleton(new AbstractDouble2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Double2ObjectFunctions.SynchronizedFunction<V> implements Double2ObjectMap<V>, java.io.Serializable {
		...
		public ObjectSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
			synchronized (sync) {
				if (entries == null) entries = ObjectSets.synchronize(map.double2ObjectEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<V> extends Double2ObjectFunctions.UnmodifiableFunction<V> implements Double2ObjectMap<V>, java.io.Serializable {
		...
		protected UnmodifiableMap(final Double2ObjectMap<? extends V> m) {
			super(m);
			this.map = m;
		}
		...
		@Override
		public ObjectSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
			if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.double2ObjectEntrySet());
			return entries;
		}
		...
		@SuppressWarnings("unchecked")
		public V getOrDefault(final double key, final V defaultValue) {
			return ((Double2ObjectMap<V>)map).getOrDefault(key, defaultValue);
		}
	 ...
	 */
	public static <V> Double2ObjectMap<V> unmodifiable(final Double2ObjectMap<? extends V> m) {
