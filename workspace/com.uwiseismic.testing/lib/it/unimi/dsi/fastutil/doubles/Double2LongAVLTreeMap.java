	...
	*/
	...
	public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2LongMap.Entry>() {
			final Comparator<? super Double2LongMap.Entry> comparator = (Double2LongAVLTreeMap.this.actualComparator == null ? (Comparator<Double2LongMap.Entry>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2LongMap.Entry>)(x, y) -> Double2LongAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
			...
			public boolean remove(final Object o) {
				...
				if (!(e.getValue() instanceof Long)) return false;
				final Entry f = findKey(((Double)(e.getKey())).doubleValue());
	...
	private final class Submap extends AbstractDouble2LongSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2LongAVLTreeMap.this.compare(k, from) >= 0) && (top || Double2LongAVLTreeMap.this.compare(k, to) < 0);
		}
