...
public final class Double2IntSortedMaps {
	...
	public static class Singleton extends Double2IntMaps.Singleton implements Double2IntSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractDouble2IntMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Double2IntMaps.SynchronizedMap implements Double2IntSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.double2IntEntrySet(), sync);
			return (ObjectSortedSet<Double2IntMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Double2IntMaps.UnmodifiableMap implements Double2IntSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.double2IntEntrySet());
			return (ObjectSortedSet<Double2IntMap.Entry>)entries;
		}
