...
public class Double2ObjectRBTreeMap<V> extends AbstractDouble2ObjectSortedMap<V> implements java.io.Serializable, Cloneable {
	...
	public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
		if (entries == null) entries = new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>() {
			final Comparator<? super Double2ObjectMap.Entry<V>> comparator = (Double2ObjectRBTreeMap.this.actualComparator == null ? (Comparator<Double2ObjectMap.Entry<V>>)(x, y) -> (Double.compare((x.getDoubleKey()), (y.getDoubleKey()))) : (Comparator<Double2ObjectMap.Entry<V>>)(x, y) -> Double2ObjectRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey()));
	...
	private final class Submap extends AbstractDouble2ObjectSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2ObjectRBTreeMap.this.compare(k, from) >= 0) && (top || Double2ObjectRBTreeMap.this.compare(k, to) < 0);
		}
