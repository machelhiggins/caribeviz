...
public interface DoubleSpliterator extends Spliterator.OfDouble {
	...
	default boolean tryAdvance(final Consumer<? super Double> action) {
		...
		return tryAdvance(action instanceof java.util.function.DoubleConsumer ? (java.util.function.DoubleConsumer)action : (java.util.function.DoubleConsumer)action::accept);
	}
	 ...
	 */
	default boolean tryAdvance(final DoubleConsumer action) {
	...
	default long skip(final long n) {
		...
		long i = n;
		while (i-- != 0 && tryAdvance((double unused) -> {
		})) {
