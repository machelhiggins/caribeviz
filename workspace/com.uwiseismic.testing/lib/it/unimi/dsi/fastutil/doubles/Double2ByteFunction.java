...
public interface Double2ByteFunction extends Function<Double, Byte>, java.util.function.DoubleToIntFunction {
	...
	default it.unimi.dsi.fastutil.doubles.Double2ByteFunction andThenByte(it.unimi.dsi.fastutil.bytes.Byte2ByteFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2ByteFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2ShortFunction andThenShort(it.unimi.dsi.fastutil.bytes.Byte2ShortFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2ByteFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2IntFunction andThenInt(it.unimi.dsi.fastutil.bytes.Byte2IntFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2ByteFunction composeInt(it.unimi.dsi.fastutil.ints.Int2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2LongFunction andThenLong(it.unimi.dsi.fastutil.bytes.Byte2LongFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2ByteFunction composeLong(it.unimi.dsi.fastutil.longs.Long2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2CharFunction andThenChar(it.unimi.dsi.fastutil.bytes.Byte2CharFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2ByteFunction composeChar(it.unimi.dsi.fastutil.chars.Char2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2FloatFunction andThenFloat(it.unimi.dsi.fastutil.bytes.Byte2FloatFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2ByteFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2ByteFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2DoubleFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.doubles.Double2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.bytes.Byte2ObjectFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2ByteFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2DoubleFunction<? super T> before) {
		return k -> get(before.getDouble(k));
	}

	default <T> it.unimi.dsi.fastutil.doubles.Double2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2ByteFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2DoubleFunction<? super T> before) {
		return k -> get(before.getDouble(k));
	}
}
