...
public final class Double2DoubleSortedMaps {
	...
	public static class Singleton extends Double2DoubleMaps.Singleton implements Double2DoubleSortedMap, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractDouble2DoubleMap.BasicEntry(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap extends Double2DoubleMaps.SynchronizedMap implements Double2DoubleSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.double2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Double2DoubleMap.Entry>)entries;
		}
	...
	public static class UnmodifiableSortedMap extends Double2DoubleMaps.UnmodifiableMap implements Double2DoubleSortedMap, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.double2DoubleEntrySet());
			return (ObjectSortedSet<Double2DoubleMap.Entry>)entries;
		}
