...
public final class Double2ObjectSortedMaps {
	...
	public static class Singleton<V> extends Double2ObjectMaps.Singleton<V> implements Double2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
		...
		@Override
		public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.singleton(new AbstractDouble2ObjectMap.BasicEntry<>(key, value), entryComparator(comparator));
	...
	public static class SynchronizedSortedMap<V> extends Double2ObjectMaps.SynchronizedMap<V> implements Double2ObjectSortedMap<V>, java.io.Serializable {
		...
		@Override
		public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.synchronize(sortedMap.double2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Double2ObjectMap.Entry<V>>)entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Double2ObjectMaps.UnmodifiableMap<V> implements Double2ObjectSortedMap<V>, java.io.Serializable {
		...
		protected UnmodifiableSortedMap(final Double2ObjectSortedMap<? extends V> m) {
			super(m);
			sortedMap = m;
		}
		...
		@Override
		public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
			if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.double2ObjectEntrySet());
			return (ObjectSortedSet<Double2ObjectMap.Entry<V>>)entries;
		}
	 ...
	 */
	public static <V> Double2ObjectSortedMap<V> unmodifiable(final Double2ObjectSortedMap<? extends V> m) {
