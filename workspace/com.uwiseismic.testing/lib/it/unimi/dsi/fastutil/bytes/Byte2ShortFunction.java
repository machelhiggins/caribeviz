...
public interface Byte2ShortFunction extends Function<Byte, Short>, java.util.function.IntUnaryOperator {
	...
	default it.unimi.dsi.fastutil.bytes.Byte2ByteFunction andThenByte(it.unimi.dsi.fastutil.shorts.Short2ByteFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2ShortFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2ByteFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2ShortFunction andThenShort(it.unimi.dsi.fastutil.shorts.Short2ShortFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.shorts.Short2ShortFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2ByteFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2IntFunction andThenInt(it.unimi.dsi.fastutil.shorts.Short2IntFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.ints.Int2ShortFunction composeInt(it.unimi.dsi.fastutil.ints.Int2ByteFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2LongFunction andThenLong(it.unimi.dsi.fastutil.shorts.Short2LongFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.longs.Long2ShortFunction composeLong(it.unimi.dsi.fastutil.longs.Long2ByteFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2CharFunction andThenChar(it.unimi.dsi.fastutil.shorts.Short2CharFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.chars.Char2ShortFunction composeChar(it.unimi.dsi.fastutil.chars.Char2ByteFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2FloatFunction andThenFloat(it.unimi.dsi.fastutil.shorts.Short2FloatFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.floats.Float2ShortFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2ByteFunction before) {
		return k -> get(before.get(k));
	}

	default it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction andThenDouble(it.unimi.dsi.fastutil.shorts.Short2DoubleFunction after) {
		return k -> after.get(get(k));
	}

	default it.unimi.dsi.fastutil.doubles.Double2ShortFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2ByteFunction before) {
		return k -> get(before.get(k));
	}

	default <T> it.unimi.dsi.fastutil.bytes.Byte2ObjectFunction<T> andThenObject(it.unimi.dsi.fastutil.shorts.Short2ObjectFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Object2ShortFunction<T> composeObject(it.unimi.dsi.fastutil.objects.Object2ByteFunction<? super T> before) {
		return k -> get(before.getByte(k));
	}

	default <T> it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunction<T> andThenReference(it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction<? extends T> after) {
		return k -> after.get(get(k));
	}

	default <T> it.unimi.dsi.fastutil.objects.Reference2ShortFunction<T> composeReference(it.unimi.dsi.fastutil.objects.Reference2ByteFunction<? super T> before) {
		return k -> get(before.getByte(k));
	}
}
